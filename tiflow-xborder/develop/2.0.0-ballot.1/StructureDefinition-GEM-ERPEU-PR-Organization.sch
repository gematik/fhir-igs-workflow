...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <!-- 
    This file contains just the constraints for the profile TIOrganization
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Organization">
      <sch:assert test="count(f:extension[@url = 'https://gematik.de/fhir/ti/StructureDefinition/ncpeh-country-extension']) &lt;= 1">extension with URL = 'https://gematik.de/fhir/ti/StructureDefinition/ncpeh-country-extension': maximum cardinality of 'extension' is 1</sch:assert>
