# GET-Prescription-EU - TIFlow - Grenzüberschreitender Datenaustausch v2.0.0-ballot.1
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/erp-eu/OperationDefinition/GET-Prescription-EUOperationDefinition | *Version*:2.0.0-ballot.1 |
