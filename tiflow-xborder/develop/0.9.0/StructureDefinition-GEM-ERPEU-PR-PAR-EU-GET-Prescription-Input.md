# GEM ERPEU PR PAR GET Prescription Input - TIFlow - Grenzüberschreitender Datenaustausch v0.9.0
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/tiflow/xborder/StructureDefinition/GEM-ERPEU-PR-PAR-EU-GET-Prescription-Input | *Version*:0.9.0 |
