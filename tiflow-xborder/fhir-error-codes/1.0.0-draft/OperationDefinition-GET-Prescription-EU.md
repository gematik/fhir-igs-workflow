# GET-Prescription-EU - TIFlow - Grenzüberschreitender Datenaustausch v1.0.0-draft
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/erp-eu/OperationDefinition/GET-Prescription-EUOperationDefinition | *Version*:1.0.0-draft |
