# Dispense Data from EU - Implementation Guide TIFlow - Grenzüberschreitender Datenaustausch v2.0.0-ballot.2
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/tiflow-xborder/StructureDefinition/logical-eu-dispense-data | *Version*:2.0.0-ballot.2 |
| Draft as of 2026-06-30 | *Computable Name*:GEM_ERPEU_LOG_DispenseData |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/de.gematik.tiflow.xborder|current/StructureDefinition/StructureDefinition-logical-eu-dispense-data.json)
...
```json
{
  ...
  "url" : "https://gematik.de/fhir/tiflow-xborder/StructureDefinition/logical-eu-dispense-data",
  ...
  "kind" : "logical",
  "abstract" : false,
  "type" : "https://gematik.de/fhir/tiflow-xborder/StructureDefinition/logical-eu-dispense-data",
