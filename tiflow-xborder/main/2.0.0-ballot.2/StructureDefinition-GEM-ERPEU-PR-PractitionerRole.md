# PractitionerRole Information Received from the EU - Implementation Guide TIFlow - Grenzüberschreitender Datenaustausch v2.0.0-ballot.2
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/tiflow-xborder/StructureDefinition/GEM-ERPEU-PR-PractitionerRole | *Version*:2.0.0-ballot.2 |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/de.gematik.tiflow.xborder|current/StructureDefinition/StructureDefinition-GEM-ERPEU-PR-PractitionerRole.json)
