# Downloads - Implementation Guide TIFlow - Grenzüberschreitender Datenaustausch v2.0.0-ballot.2
...
Die hier bereitgestellten Dateien sind als normativ zu betrachten, wenn nicht anders dargestellt. Downloads an anderer Stelle, wie
[Simplifier](https://simplifier.net/erezept-workflow-eu), dienen ausschließlich als Hilfestellung bei der Implementierung und sind daher nicht normativ. Für eine vollständige und korrekte Implementierung sind die offiziellen Spezifikationen und begleitenden Dokumentationen maßgeblich.
