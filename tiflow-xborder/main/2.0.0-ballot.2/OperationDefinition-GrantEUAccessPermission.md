# GrantEUAccessPermission - Implementation Guide TIFlow - Grenzüberschreitender Datenaustausch v2.0.0-ballot.2
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/tiflow-xborder/OperationDefinition/GrantEUAccessPermission | *Version*:2.0.0-ballot.2 |
...
```json
{
  ...
  "url" : "https://gematik.de/fhir/tiflow-xborder/OperationDefinition/GrantEUAccessPermission",
