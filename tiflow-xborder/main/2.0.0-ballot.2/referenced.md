# Referenzen - Implementation Guide TIFlow - Grenzüberschreitender Datenaustausch v2.0.0-ballot.2
...
# Referenzierte Dokumente und Abkürzungen
...
| NCPeH‑FD | National Contact Point eHealth in Deutschland, NCPeH‑Fachdienst |
...
* gemSpec_eRp_FdV: Spezifikation E‑Rezept‑Frontend des Versicherten
* gemSpec_Kon: Spezifikation Konnektor
* gemSpec_Krypt: Spezifikation kryptographische Algorithmen in der TI
* gemSpec_VZD_FHIR_Directory: Spezifikation Verzeichnisdienst FHIR‑Directory
* gemF_ePres-eDisp: Feature Prescription/eDispensation Land A
