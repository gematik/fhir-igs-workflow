# GEM ERPEU PR PAR PATCH Task Input - Implementation Guide TIFlow - Grenzüberschreitender Datenaustausch v2.0.0-ballot.2
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/tiflow-xborder/StructureDefinition/GEM-ERPEU-PR-PAR-PATCH-Task-Input | *Version*:2.0.0-ballot.2 |
| Draft as of 2026-06-30 | *Computable Name*:GEM_ERPEU_PR_PAR_PATCH_Task_Input |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/de.gematik.tiflow.xborder|current/StructureDefinition/StructureDefinition-GEM-ERPEU-PR-PAR-PATCH-Task-Input.json)
...
```json
{
  ...
  "url" : "https://gematik.de/fhir/tiflow-xborder/StructureDefinition/GEM-ERPEU-PR-PAR-PATCH-Task-Input",
