...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Medication">
      ...
      <sch:assert test="count(f:extension[@url = 'https://gematik.de/fhir/tiflow-xborder/StructureDefinition/GEM-ERPEU-EX-MedicinalPackageIdentifier']) &lt;= 1">extension with URL = 'https://gematik.de/fhir/tiflow-xborder/StructureDefinition/GEM-ERPEU-EX-MedicinalPackageIdentifier': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://gematik.de/fhir/tiflow-xborder/StructureDefinition/GEM-ERPEU-EX-MedicinalPackageDescription']) &lt;= 1">extension with URL = 'https://gematik.de/fhir/tiflow-xborder/StructureDefinition/GEM-ERPEU-EX-MedicinalPackageDescription': maximum cardinality of 'extension' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
