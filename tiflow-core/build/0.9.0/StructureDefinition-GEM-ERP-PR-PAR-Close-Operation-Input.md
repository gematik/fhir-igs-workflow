# GEM ERP PR CloseOperation Input - TIFlow - Kernfunktionalitäten v0.9.0
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/erp/StructureDefinition/GEM_ERP_PR_PAR_CloseOperation_Input | *Version*:0.9.0 |
