...
| Communication | `de.gematik.erezept-workflow.r4` | `GEM_ERP_PR_Communication_DispReq``GEM_ERP_PR_Communication_Reply``GEM_ERP_PR_Communication_DiGA``GEM_ERP_PR_Communication_Representative` | Zeitpunkt des Aufrufs der Operation am E-Rezept-Fachdienst |
...
| PKV Patientenrechnung Communication | `de.gematik.erezept-patientenrechnung.r4` | `GEM_ERPCHRG_PR_Communication_ChargChangeReq``GEM_ERPCHRG_PR_Communication_ChargChangeReply` | Zeitpunkt des Aufrufs der Operation am E-Rezept-Fachdienst |
