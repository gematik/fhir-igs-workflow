# Example CapabilityStatement Server RU - TIFlow - Kernfunktionalitäten v0.9.0
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/tiflow/core/CapabilityStatement/example-capabilitystatement-server-ru | *Version*:0.9.0 |
