...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Communication/f:payload">
      <sch:assert test="count(f:extension[@url = 'https://gematik.de/fhir/erp/StructureDefinition/GEM_ERP_EX_SupplyOptionsType']) &lt;= 1">extension with URL = 'https://gematik.de/fhir/erp/StructureDefinition/GEM_ERP_EX_SupplyOptionsType': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://gematik.de/fhir/erp/StructureDefinition/GEM_ERP_EX_AvailabilityState']) &lt;= 1">extension with URL = 'https://gematik.de/fhir/erp/StructureDefinition/GEM_ERP_EX_AvailabilityState': maximum cardinality of 'extension' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
</sch:schema>
