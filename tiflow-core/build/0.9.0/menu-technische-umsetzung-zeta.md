# Zero Trust Access (ZETA) - TIFlow - Kernfunktionalitäten v0.9.0
...
**Was wird geprüft?** Es wird die Berufs- bzw. Einrichtungs-OID des anfragenden Nutzers bzw. der anfragenden Institution mit einer Liste von erlaubten Kennungen abgeglichen.
...
Die Menge an möglichen Zugriffen bildet sich über die Use Cases der Anwendung TI-Flow. Jeder Use Case soll über die Zeta Policy steuerbar sein. Die Scopes leiten sich daraus ab.

**Abbildung: **Allowed Profession OID's to Use Cases
#### Scope Definition
