# GEM ERP VS OperationOutcomeDetails - TIFlow - Kernfunktionalitäten v1.0.0-draft
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/erp/ValueSet/GEM_ERP_VS_OperationOutcomeDetails | *Version*:1.0.0-draft |
| Draft as of 2025-09-25 | *Computable Name*:GEM_ERP_VS_OperationOutcomeDetails |
...
```json
{
  ...
  "url" : "https://gematik.de/fhir/erp/ValueSet/GEM_ERP_VS_OperationOutcomeDetails",
  "version" : "1.0.0-draft",
  "name" : "GEM_ERP_VS_OperationOutcomeDetails",
  ...
  "compose" : {
    "include" : [{
      "system" : "https://gematik.de/fhir/erp/CodeSystem/GEM_ERP_CS_OperationOutcomeDetails"
    },
    {
