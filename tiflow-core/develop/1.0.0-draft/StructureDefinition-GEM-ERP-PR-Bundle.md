# GEM ERP PR Bundle - TIFlow - Kernfunktionalitäten v1.0.0-draft
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/erp/StructureDefinition/GEM_ERP_PR_Bundle | *Version*:1.0.0-draft |
| Draft as of 2025-09-25 | *Computable Name*:GEM_ERP_PR_Bundle |
...
* Use this Profile: [GEM ERP PR CloseOperation Output](StructureDefinition-GEM-ERP-PR-PAR-Close-Operation-Output.md)
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/de.gematik.tiflow.core|current/StructureDefinition/GEM-ERP-PR-Bundle)
