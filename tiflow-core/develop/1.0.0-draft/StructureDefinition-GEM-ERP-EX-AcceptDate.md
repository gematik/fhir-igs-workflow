# GEM ERP EX AcceptDate - TIFlow - Kernfunktionalitäten v1.0.0-draft
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/erp/StructureDefinition/GEM_ERP_EX_AcceptDate | *Version*:1.0.0-draft |
| Draft as of 2025-09-25 | *Computable Name*:GEM_ERP_EX_AcceptDate |
...
* Search Parameters using this Extension: [TaskAcceptDateSP](SearchParameter-task-accept-date-sp.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/de.gematik.tiflow.core|current/StructureDefinition/GEM-ERP-EX-AcceptDate)
