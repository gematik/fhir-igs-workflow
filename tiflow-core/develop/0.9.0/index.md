# Implementation Guide E-Rezept-Workflow Core - TIFlow - Kernfunktionalitäten v0.9.0
...
```json
{
  ...
  "definition" : {
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "Bundle/example-searchset-communication"
      },
      "name" : "Antwortbundle fuer GET /Communication",
    ...
    },
    {
      ...
      "exampleCanonical" : "https://gematik.de/fhir/erp/StructureDefinition/GEM_ERP_PR_PAR_CloseOperation_Input"
    },
    {
      "extension" : [{
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/resource-information",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "CodeSystem/GEM-ERP-CS-CapabilityStatement-Environment"
      },
      "name" : "ERP CapabilityStatement Environment CodeSystem",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "ValueSet/GEM-ERP-VS-CapabilityStatement-Environment"
      },
      "name" : "ERP CapabilityStatement Environment ValueSet",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "ValueSet/GEM-ERP-VS-CapabilityStatement-Feature"
      },
      "name" : "ERP CapabilityStatement Feature ValueSet",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "CodeSystem/GEM-ERP-CS-FDConfiguration"
      },
      "name" : "ERP FDConfiguration CodeSystem",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "ValueSet/GEM-ERP-VS-FDConfiguration"
      },
      "name" : "ERP FDConfiguration ValueSet",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "CodeSystem/GEM-ERP-CS-Features"
      },
      "name" : "ERP Feature CodeSystem",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "CapabilityStatement/example-capabilitystatement-server-pu"
      },
      "name" : "Example CapabilityStatement Server PU",
      "description" : "Example capability statement for productive environment with common ERP features enabled.",
      "exampleCanonical" : "https://gematik.de/fhir/erp/StructureDefinition/GEM_ERP_PR_CapabilityStatement"
    },
    {
      "extension" : [{
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/resource-information",
      ...
      "reference" : {
        "reference" : "CapabilityStatement/example-capabilitystatement-server-ru"
      },
      "name" : "Example CapabilityStatement Server RU",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "CapabilityStatement/example-capabilitystatement-server-tu"
      },
      "name" : "Example CapabilityStatement Server TU",
    ...
    },
    {
      ...
      "exampleCanonical" : "https://gematik.de/fhir/erp/StructureDefinition/GEM_ERP_PR_PAR_DispenseOperation_Input"
    },
    {
      "extension" : [{
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/resource-information",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/GEM-ERP-EX-CapabilityStatement-Environment"
      },
      "name" : "GEM ERP EX CapabilityStatement Environment",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/GEM-ERP-EX-CapabilityStatement-FDConfiguration"
      },
      "name" : "GEM ERP EX CapabilityStatement FDConfiguration",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/GEM-ERP-EX-CapabilityStatement-Feature"
      },
      "name" : "GEM ERP EX CapabilityStatement Feature",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/GEM-ERP-PR-CapabilityStatement"
      },
      "name" : "GEM ERP PR CapabilityStatement",
    ...
    },
    {
      ...
      "exampleCanonical" : "https://gematik.de/fhir/erp/StructureDefinition/GEM_ERP_PR_Device"
    },
    {
      "extension" : [{
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/resource-information",
    ...
    },
    {
      ...
      "exampleCanonical" : "https://gematik.de/fhir/erp/StructureDefinition/GEM_ERP_PR_Bundle"
    },
    {
      "extension" : [{
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/resource-information",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "SearchParameter/task-accept-date-sp"
      },
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "SearchParameter/task-expiry-date-sp"
      },
