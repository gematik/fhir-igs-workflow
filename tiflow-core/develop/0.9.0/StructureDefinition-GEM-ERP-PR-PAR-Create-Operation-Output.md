# GEM ERP PR CreateOperation Output - TIFlow - Kernfunktionalitäten v0.9.0
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/erp/StructureDefinition/GEM_ERP_PR_PAR_CreateOperation_Output | *Version*:0.9.0 |
