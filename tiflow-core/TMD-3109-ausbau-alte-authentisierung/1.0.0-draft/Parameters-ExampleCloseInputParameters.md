# Beispiel Close-Parameter - TIFlow - Kernfunktionalitäten v1.0.0-draft
...
```json
{
  ...
  "meta" : {
    "profile" : ["https://gematik.de/fhir/erp/StructureDefinition/GEM_ERP_PR_PAR_CloseOperation_Input|1.6"]
  },
  "parameter" : [{
    "name" : "rxDispensation",
    "part" : [{
