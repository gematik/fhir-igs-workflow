# Example CapabilityStatement Server TU - TIFlow - Kernfunktionalitäten v1.0.0-draft
...
* **Example CapabilityStatement Server TU**

## CapabilityStatement: Example CapabilityStatement Server TU 

| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/tiflow/core/CapabilityStatement/example-capabilitystatement-server-tu | *Version*:1.0.0-draft |
| Active as of 2026-03-16 | *Computable Name*:ExampleCapabilityStatementServerTU |
...
```json
{
  ...
  "url" : "https://gematik.de/fhir/tiflow/core/CapabilityStatement/example-capabilitystatement-server-tu",
  "version" : "1.0.0-draft",
