# Telemetry Data Status Codes Concept Map - TIFlow - Kernfunktionalitäten v1.0.0-draft
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/tiflow/core/ConceptMap/TIFLOW-CM-TelemetryDataStatusCodes | *Version*:1.0.0-draft |
...
```json
{
  ...
  "group" : [{
    ...
    "target" : "telemetriedaten-ti-flow",
    "element" : [{
