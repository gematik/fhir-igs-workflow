# Example Parameters - example-case-01-digitaler-durchschlag - Datenaustausch E-Rezept-Fachdienst und BfArM Webdienst v1.0.0
...
* **Example Parameters - example-case-01-digitaler-durchschlag**

## Example Parameters: Example Parameters - example-case-01-digitaler-durchschlag
...
```json
{
  ...
  "id" : "example-case-01-digitaler-durchschlag",
  "meta" : {
