# E-T-Rezept Medication - Datenaustausch E-Rezept-Fachdienst und BfArM Webdienst v1.0.0
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/erp-t-prescription/StructureDefinition/erp-tprescription-medication | *Version*:1.0.0 |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/de.gematik.erp-t-prescription|current/StructureDefinition/erp-tprescription-medication)
