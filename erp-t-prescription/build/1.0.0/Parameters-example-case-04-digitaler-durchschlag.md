# Example Parameters - example-case-04-digitaler-durchschlag - Datenaustausch E-Rezept-Fachdienst und BfArM Webdienst v1.0.0
...
* **Example Parameters - example-case-04-digitaler-durchschlag**

## Example Parameters: Example Parameters - example-case-04-digitaler-durchschlag
...
```json
{
  ...
  "id" : "example-case-04-digitaler-durchschlag",
  "meta" : {
