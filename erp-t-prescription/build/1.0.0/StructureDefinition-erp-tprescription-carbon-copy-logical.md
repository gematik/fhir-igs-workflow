# Logisches Modell digitaler Durchschlag E-T-Rezept - Datenaustausch E-Rezept-Fachdienst und BfArM Webdienst v1.0.0
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/erp-t-prescription/StructureDefinition/erp-tprescription-carbon-copy-logical | *Version*:1.0.0 |
| Draft as of 2026-03-02 | *Computable Name*:ERP_TPrescription_CarbonCopy_Logical |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/de.gematik.erp-t-prescription|current/StructureDefinition/erp-tprescription-carbon-copy-logical)
