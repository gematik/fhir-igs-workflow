...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/erp-diga/StructureDefinition/GEM-ERP-PR-PAR-CloseOperation-Input | *Version*:2.0.0-draft |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/de.gematik.eflow-diga|current/StructureDefinition/GEM-ERP-PR-PAR-CloseOperation-Input)
...
```json
{
  ...
  "url" : "https://gematik.de/fhir/erp-diga/StructureDefinition/GEM-ERP-PR-PAR-CloseOperation-Input",
  "version" : "2.0.0-draft",
