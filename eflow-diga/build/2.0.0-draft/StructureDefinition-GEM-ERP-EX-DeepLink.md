# GEM ERP EX DeepLink - Verordnungen fuer Digitale Gesundheitsanwendungen (DiGA) v2.0.0-draft
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/erp-diga/StructureDefinition/GEM_ERP_EX_DeepLink | *Version*:2.0.0-draft |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/de.gematik.eflow-diga|current/StructureDefinition/GEM-ERP-EX-DeepLink)
