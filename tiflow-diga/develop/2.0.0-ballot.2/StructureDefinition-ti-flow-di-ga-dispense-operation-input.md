# TIFlow DiGA Dispense Operation Input - TIFlow - Verordnungen für Digitale Gesundheitsanwendungen (DiGA) v2.0.0-ballot.2
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/tiflow-diga/StructureDefinition/ti-flow-di-ga-dispense-operation-input | *Version*:2.0.0-ballot.2 |
