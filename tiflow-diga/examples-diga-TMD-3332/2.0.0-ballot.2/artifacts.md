...
* [DiGA-Nachricht eines Kostenträgers an den Patienten](Communication-140f716f-f649-44fe-9a4e-157eb3c8adf3-payload.md)

* [DiGA-Nachricht eines Kostenträgers an den Patienten](Communication-140f716f-f649-44fe-9a4e-157eb3c8adf3-reponse.md)
...
* [Fehler 403 - Beispiel für Create-Operation Fehlerantwort](OperationOutcome-ExampleCreateOperationOutputError.md)
...
* [Fehler 403 - Beispiel für Abort-Operation Fehlerantwort bei Rollenprüfung (FdV)](OperationOutcome-ExampleOperationAbortErrorRoleFdV.md)
...
* [Error 400 - QES nicht durch berechtigte Berufsgruppe; Example Activate operation error response](OperationOutcome-ExampleOperationActivateInvalidRoleError.md)

* [Beispiel für Close-Operation Fehlerantwort](OperationOutcome-ExampleOperationCloseError.md)

* [Fehler 400 - Beispiel für Close-Operation Fehlerantwort bei Profilprüfung MedicationDispense](OperationOutcome-ExampleOperationCloseProfileError.md)
...
* [erp-diga-01-task-162-create](Task-162.000.000.000.000.01.md)
