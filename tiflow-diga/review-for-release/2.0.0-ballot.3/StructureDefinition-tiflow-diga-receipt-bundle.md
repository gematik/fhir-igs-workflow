# DiGA Quittungsbundle - Implementation Guide TIFlow - Verordnungen für Digitale Gesundheitsanwendungen (DiGA) v2.0.0-ballot.3
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/tiflow-diga/StructureDefinition/tiflow-diga-receipt-bundle | *Version*:2.0.0-ballot.3 |
| Active as of 2026-06-30 | *Computable Name*:TIFlowDiGAReceiptBundle |
...
* Examples for this Profile: [Bundle/ExampleOperationCloseOutput](Bundle-ExampleOperationCloseOutput.md)
