# Quittungs-Bundle für abgeschlossene Rezeptabgabe - Implementation Guide TIFlow - Verordnungen für Digitale Gesundheitsanwendungen (DiGA) v2.0.0-ballot.3
...
{
  "resourceType" : "Bundle",
  "id" : "ExampleOperationCloseOutput",
  "meta" : {
  ...
  "entry" : [{
    ...
    "resource" : {
      ...
      "meta" : {
        "profile" : ["https://gematik.de/fhir/tiflow-diga/StructureDefinition/tiflow-diga-receipt-composition"]
      },
      "extension" : [{
        "url" : "https://gematik.de/fhir/erp/StructureDefinition/GEM_ERP_EX_Beneficiary",
        "valueIdentifier" : {
          "system" : "https://gematik.de/fhir/sid/telematik-id",
          "value" : "8-SMC-B-Testkarte-883110000129070"
        }
      }],
      "status" : "final",
      "type" : {
