# $accept response for DiGA - Implementation Guide TIFlow - Verordnungen für Digitale Gesundheitsanwendungen (DiGA) v2.0.0-ballot.3
...
* **$accept response for DiGA**

## Example Bundle: $accept response for DiGA
...
```json
{
  ...
  "link" : [{
    "relation" : "self",
    "url" : "https://erp-ref.example.org/Task/162.000.000.000.000.01/$accept"
  }],
  "entry" : [{
  ...
  {
    "fullUrl" : "https://erp-ref.example.org/Binary/ExampleDiGABinary",
    "resource" : {
      "resourceType" : "Binary",
      "id" : "ExampleDiGABinary",
      "meta" : {
