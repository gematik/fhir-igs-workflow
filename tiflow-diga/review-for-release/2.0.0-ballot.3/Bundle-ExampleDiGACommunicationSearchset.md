# Communication searchset response for DiGA - Implementation Guide TIFlow - Verordnungen für Digitale Gesundheitsanwendungen (DiGA) v2.0.0-ballot.3
...
```json
{
  ...
  "entry" : [{
    "fullUrl" : "https://erp-ref.example.org/Communication/Communication-Reply-DiGA",
    "resource" : {
