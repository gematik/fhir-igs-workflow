# Example Close Parameters - Implementation Guide TIFlow - Verordnungen für Digitale Gesundheitsanwendungen (DiGA) v2.0.0-ballot.3
...
```json
{
  ...
  "meta" : {
    "profile" : ["https://gematik.de/fhir/tiflow-diga/StructureDefinition/ti-flow-di-ga-close-operation-input"]
  },
  "parameter" : [{
    "name" : "rxDispensation",
    "part" : [{
