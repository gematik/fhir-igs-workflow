# GEM ERP PR Communication DiGA - Implementation Guide TIFlow - Verordnungen für Digitale Gesundheitsanwendungen (DiGA) v2.0.0-ballot.3
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/erp/StructureDefinition/GEM_ERP_PR_Communication_DiGA | *Version*:2.0.0-ballot.3 |
| Active as of 2026-06-30 | *Computable Name*:GEM_ERP_PR_Communication_DiGA |
...
* Examples for this Profile: [Communication/Communication-Reply-DiGA-payload](Communication-Communication-Reply-DiGA-payload.md) and [Communication/Communication-Reply-DiGA](Communication-Communication-Reply-DiGA.md)
