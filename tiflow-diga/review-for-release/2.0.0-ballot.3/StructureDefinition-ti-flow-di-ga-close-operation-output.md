# TIFlow DiGA Close Operation Output - Implementation Guide TIFlow - Verordnungen für Digitale Gesundheitsanwendungen (DiGA) v2.0.0-ballot.3
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/tiflow-diga/StructureDefinition/ti-flow-di-ga-close-operation-output | *Version*:2.0.0-ballot.3 |
| Active as of 2026-06-30 | *Computable Name*:TIFlowDiGACloseOperationOutput |
...
* Examples for this Profile: [Parameters/ExampleCloseOutputParametersDiGA](Parameters-ExampleCloseOutputParametersDiGA.md)
