# ERP DiGA CapabilityStatement für den E-Rezept-Fachdienst - Implementation Guide TIFlow - Verordnungen für Digitale Gesundheitsanwendungen (DiGA) v2.0.0-ballot.3
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/tiflow-diga/CapabilityStatement/ti-flow-fachdienst-server-diga | *Version*:2.0.0-ballot.3 |
  ...
  "rest" : [{
    ...
    "resource" : [{
      ...
      },
      {
        ...
        "documentation" : "Payor claims an ePrescription and sets Task status to in-progress"
      },
      {
        "extension" : [{
          "url" : "http://hl7.org/fhir/StructureDefinition/capabilitystatement-expectation",
