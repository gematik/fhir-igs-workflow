...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:MedicationDispense">
      ...
      <sch:assert test="count(f:extension[@url = 'https://gematik.de/fhir/tiflow/diga/StructureDefinition/GEM_ERP_EX_RedeemCode']) &lt;= 1">extension with URL = 'https://gematik.de/fhir/tiflow/diga/StructureDefinition/GEM_ERP_EX_RedeemCode': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://gematik.de/fhir/tiflow/diga/StructureDefinition/GEM_ERP_EX_DeepLink']) &lt;= 1">extension with URL = 'https://gematik.de/fhir/tiflow/diga/StructureDefinition/GEM_ERP_EX_DeepLink': maximum cardinality of 'extension' is 1</sch:assert>
