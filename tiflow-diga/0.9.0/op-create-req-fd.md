# Anforderungen an den E-Rezept-Fachdienst für die $create-Operation - TIFlow - Verordnungen für Digitale Gesundheitsanwendungen (DiGA) v0.9.0
...
* **Anforderungen an den E-Rezept-Fachdienst für die $create-Operation**
