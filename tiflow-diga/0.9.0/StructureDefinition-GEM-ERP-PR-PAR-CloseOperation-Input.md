# GEM ERP PR CloseOperation Input - TIFlow - Verordnungen für Digitale Gesundheitsanwendungen (DiGA) v0.9.0
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/tiflow/diga/StructureDefinition/GEM-ERP-PR-PAR-CloseOperation-Input | *Version*:0.9.0 |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/de.gematik.tiflow.diga|current/StructureDefinition/GEM-ERP-PR-PAR-CloseOperation-Input)
...
Other representations of profile: [CSV](StructureDefinition-GEM-ERP-PR-PAR-CloseOperation-Input.csv), [Excel](StructureDefinition-GEM-ERP-PR-PAR-CloseOperation-Input.xlsx), [Schematron](StructureDefinition-GEM-ERP-PR-PAR-CloseOperation-Input.sch) 
...
```json
{
  ...
  "url" : "https://gematik.de/fhir/tiflow/diga/StructureDefinition/GEM-ERP-PR-PAR-CloseOperation-Input",
  "version" : "0.9.0",
  ...
  "differential" : {
    ...
    },
    {
      ...
      "constraint" : [{
        ...
        "source" : "https://gematik.de/fhir/tiflow/diga/StructureDefinition/GEM-ERP-PR-PAR-CloseOperation-Input"
      },
      {
