# Anforderungen an den TI-Flow-Fachdienst für die $reject-Operation - Implementation Guide TIFlow - Verordnungen für Digitale Gesundheitsanwendungen (DiGA) v2.0.0-ballot.2
