# Medication Dispense DiGA with a deep link. - Implementation Guide TIFlow - Verordnungen für Digitale Gesundheitsanwendungen (DiGA) v2.0.0-ballot.2
...
```json
{
  ...
  },
  {
    ...
    "valueUrl" : "https://example.com?redeemCode=DE12345678901234"
  }],
  "identifier" : [{
