# Logical DiGA Medication Dispense - Implementation Guide TIFlow - Verordnungen für Digitale Gesundheitsanwendungen (DiGA) v2.0.0-ballot.2
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/tiflow-diga/StructureDefinition/GEM-ERP-LOG-MedicationDispense-DiGA | *Version*:2.0.0-ballot.2 |
| Active as of 2026-06-30 | *Computable Name*:GEM_ERP_LOG_MedicationDispense_DiGA |
| **Copyright/Legal**: gematik GmbH / Dieses Artefakt ist lizenziert unter [Apache License](./license.md), Version 2.0. | |

 
Fachliches Modell zur Beschreibung der Informationen, die bei $close in der MedicationDispense-Ressource für DiGAs übermittelt werden. 

**Usages:**

* This Logical Model is not used by any profiles in this Specification

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/de.gematik.tiflow.diga|current/StructureDefinition/StructureDefinition-GEM-ERP-LOG-MedicationDispense-DiGA.json)
...
```json
{
  ...
  "url" : "https://gematik.de/fhir/tiflow-diga/StructureDefinition/GEM-ERP-LOG-MedicationDispense-DiGA",
  ...
  "kind" : "logical",
  "abstract" : false,
  "type" : "https://gematik.de/fhir/tiflow-diga/StructureDefinition/GEM-ERP-LOG-MedicationDispense-DiGA",
  ...
  "differential" : {
    "element" : [{
      ...
      "definition" : "Fachliches Modell zur Beschreibung der Informationen, die bei $close in der MedicationDispense-Ressource für DiGAs übermittelt werden.",
      "mapping" : [{
        "identity" : "GEM-ERP-MAP-MedicationDispense-DiGA",
