# PractitionerRole Information Received from the EU - E-Rezept Workflow EU v1.0.1
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/erp-eu//StructureDefinition/GEM-ERPEU-PR-PractitionerRole | *Version*:1.0.1 |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/de.gematik.erezept.eu|current/StructureDefinition/GEM-ERPEU-PR-PractitionerRole)
...
```json
{
  ...
  "url" : "https://gematik.de/fhir/erp-eu//StructureDefinition/GEM-ERPEU-PR-PractitionerRole",
  "version" : "1.0.1",
  ...
  "differential" : {
    "element" : [{
      ...
      "type" : [{
        "code" : "Reference",
        "targetProfile" : ["https://gematik.de/fhir/erp-eu//StructureDefinition/GEM-ERPEU-PR-Practitioner"]
      }]
    },
    {
      ...
      "type" : [{
        "code" : "Reference",
        "targetProfile" : ["https://gematik.de/fhir/erp-eu//StructureDefinition/GEM-ERPEU-PR-Organization"]
      }]
    }]
  }
}
