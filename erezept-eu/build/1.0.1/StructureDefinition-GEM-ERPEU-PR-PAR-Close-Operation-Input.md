# GEM ERP PR EU CloseOperation Input - E-Rezept Workflow EU v1.0.1
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/erp-eu//StructureDefinition/GEM-ERPEU-PR-PAR-Close-Operation-Input | *Version*:1.0.1 |
| Active as of 2026-01-08 | *Computable Name*:GEM_ERPEU_PR_PAR_CloseOperation_Input |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/de.gematik.erezept.eu|current/StructureDefinition/GEM-ERPEU-PR-PAR-Close-Operation-Input)
...
```json
{
  ...
  "url" : "https://gematik.de/fhir/erp-eu//StructureDefinition/GEM-ERPEU-PR-PAR-Close-Operation-Input",
  "version" : "1.0.1",
  ...
  "differential" : {
    ...
    },
    {
      ...
      "constraint" : [{
        ...
        "source" : "https://gematik.de/fhir/erp-eu//StructureDefinition/GEM-ERPEU-PR-PAR-Close-Operation-Input"
      }]
    },
    {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Medication",
        "profile" : ["https://gematik.de/fhir/erp-eu//StructureDefinition/GEM-ERPEU-PR-Medication"]
      }]
    },
    {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Practitioner",
        "profile" : ["https://gematik.de/fhir/erp-eu//StructureDefinition/GEM-ERPEU-PR-Practitioner"]
      }]
    },
    {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Organization",
        "profile" : ["https://gematik.de/fhir/erp-eu//StructureDefinition/GEM-ERPEU-PR-Organization"]
      }]
    },
    {
    ...
    },
    {
      ...
      "type" : [{
        ...
        "profile" : ["https://gematik.de/fhir/erp-eu//StructureDefinition/GEM-ERPEU-PR-PractitionerRole"]
      }]
    },
    {
