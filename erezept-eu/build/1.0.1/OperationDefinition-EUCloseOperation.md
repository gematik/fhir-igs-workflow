# EUCloseOperation - E-Rezept Workflow EU v1.0.1
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/erp-eu/OperationDefinition/EUCloseOperationDefinition | *Version*:1.0.1 |
...
```json
{
  ...
  "type" : false,
  "instance" : true,
  "inputProfile" : "https://gematik.de/fhir/erp-eu//StructureDefinition/GEM-ERPEU-PR-PAR-Close-Operation-Input",
  "parameter" : [{
    "name" : "requestData",
    "use" : "in",
    "min" : 1,
