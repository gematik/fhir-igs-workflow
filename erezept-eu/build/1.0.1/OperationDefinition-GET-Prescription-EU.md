# GET-Prescription-EU - E-Rezept Workflow EU v1.0.1
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/erp-eu/OperationDefinition/GET-Prescription-EUOperationDefinition | *Version*:1.0.1 |
...
```json
{
  ...
  "type" : false,
  "instance" : false,
  "inputProfile" : "https://gematik.de/fhir/erp-eu//StructureDefinition/GEM-ERPEU-PR-PAR-EU-GET-Prescription-Input",
  "outputProfile" : "https://gematik.de/fhir/erp-eu//StructureDefinition/gem-erpeu-pr-par-get-prescription-output",
  "parameter" : [{
    "name" : "requestData",
    "use" : "in",
    "min" : 1,
