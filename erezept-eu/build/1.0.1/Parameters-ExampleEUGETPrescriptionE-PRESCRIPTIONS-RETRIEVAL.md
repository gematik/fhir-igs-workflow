# Resource ExampleEUGETPrescriptionE-PRESCRIPTIONS-RETRIEVAL (Parameters)
...
```json
{
  ...
  "meta" : {
    "profile" : ["https://gematik.de/fhir/erp-eu//StructureDefinition/GEM-ERPEU-PR-PAR-EU-GET-Prescription-Input"]
  },
  "parameter" : [{
    "name" : "requestData",
    "part" : [{
