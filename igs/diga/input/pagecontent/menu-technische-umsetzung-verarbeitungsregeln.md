...
Der Statusübergang von "in Abgabe (gesperrt)" zu "gelöscht" über "UC 4.3 - E-Rezept durch Abgebenden löschen" ist für
DiGA Verordnungen nicht vorgesehen.

## Löschfristen
Die Löschfristen für Verordnungen des Flowtype 162 entsprechen denen des
Flowtype 160.

## Zugriff auf FHIR-VZD
Zur Prüfung der IKNR muss der E-Rezept-Fachdienst die Telematik-ID des
Kostenträgers auflösen. Das Mapping erfolgt über das FHIR-VZD und kann bis zu
