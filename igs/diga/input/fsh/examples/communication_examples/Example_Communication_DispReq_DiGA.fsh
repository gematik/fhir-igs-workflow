...
Description: "Beispiel fuer eine Nachricht des Patienten an die Krankenkasse zur Anfrage der DiGA-Abgabe mit AccessCode"
Usage: #example
...
* extension[flowType].valueCoding = https://gematik.de/fhir/erp/CodeSystem/GEM_ERP_CS_FlowType#162 "Flowtype fuer Digitale Gesundheitsanwendungen"
