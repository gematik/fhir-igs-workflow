...
- A_23152: Nicht belieferte, aber bereits reservierte E-Rezepte MUESSEN durch den Client wieder zurueckgegeben werden.
- A_19292: Fuer den erneuten Quittungsabruf MUSS `GET /Task/<id>?secret=...` verwendet werden.
