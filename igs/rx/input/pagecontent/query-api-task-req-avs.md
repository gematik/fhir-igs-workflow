...
Für diese Schnittstelle gelten die Anforderungen aus der [Core-Spezifikation](https://gemspec.gematik.de/ig/fhir/tiflow/{ site.data.constants.tiflow_core_version }/query-api-task-req-avs.html)
...
<!-- A_22435-02 -->
<requirement conformance="SHALL" key="IG-TIFLOW-ERP-A10" title="PS abgebende LEI: E-Rezepte von Versicherten abrufen (PoPP) - PoPP-Token abrufen" version="0">
...
<!-- A_22437-02 -->
<requirement conformance="SHALL" key="IG-TIFLOW-ERP-A11" title="PS abgebende LEI: E-Rezepte von Versicherten abrufen (PoPP) - E-Rezepte abrufen" version="0">
  <meta lockversion="false"/>
  <actor name="PS_TI-Flow_Apotheke" description="PS-Schnittstelle für TI-Flow/Apotheke">
    <testProcedure id="Herstellererklärung">funkt. Eignung: Herstellererklärung</testProcedure>
  </actor>
...
<!-- A_23152 -->
<requirement conformance="SHALL" key="IG-TIFLOW-ERP-A12" title="PS abgebende LEI: E-Rezepte von Versicherten abrufen - nicht belieferte E-Rezepte zurückgeben" version="0">
  <meta lockversion="false"/>
  <actor name="PS_TI-Flow_Apotheke" description="PS-Schnittstelle für TI-Flow/Apotheke">
    <testProcedure id="Herstellererklärung">funkt. Eignung: Herstellererklärung</testProcedure>
  </actor>
