...
Der Versicherte nutzt für die Verwaltung von Einwilligung und Zugriffsberechtigung ein TI-Flow-FdV, welches direkt mit dem TI-Flow-Fachdienst kommuniziert.
...
<!-- A_27097 -->
<requirement conformance="SHALL" key="IG-TIFLOW-ERP-A224" title="Format Zugriffscode" version="0">
...
<!-- A_27095 -->
<requirement conformance="SHALL" key="IG-TIFLOW-ERP-A225" title="TI-Flow-Fachdienst - Zugriffsberechtigung - Liste zulässiger Länder" version="0">
    <meta lockversion="false"/>
    <actor name="TI-Flow_FD" description="TI-Flow-Fachdienst">
        <testProcedure id="Produkttest">funkt. Eignung: Test Produkt/FA</testProcedure>
    </actor>
...
<!-- A_27096 -->
<requirement conformance="SHALL NOT" key="IG-TIFLOW-ERP-A226" title="TI-Flow-Fachdienst - Zugriffsberechtigung - Caching Liste zulässiger Länder" version="0">
    <meta lockversion="false"/>
    <actor name="TI-Flow_FD" description="TI-Flow-Fachdienst">
