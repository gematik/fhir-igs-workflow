...
- [Server Anforderungen zu `$grant-eu-access-permission`](./op-grant-eu-access-permission-req-fd.html): Anforderungen an den TI-Flow-Fachdienst zur Bereitstellung der Schnittstelle.
- [FdV-Anforderungen zu `$grant-eu-access-permission`](./op-grant-eu-access-permission-req-fdv.html): Anforderungen an das TI-Flow-FdV zur Nutzung der Schnittstelle.
