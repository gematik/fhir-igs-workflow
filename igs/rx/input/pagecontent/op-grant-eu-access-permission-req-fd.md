...
<!-- A_27090 -->
<requirement conformance="SHALL" key="IG-TIFLOW-ERP-A282" title="TI-Flow-Fachdienst - Zugriffsberechtigung schreiben - Prüfung Ländercode" version="0">
    <meta lockversion="false"/>
    <actor name="TI-Flow_FD" description="TI-Flow-Fachdienst">
        <testProcedure id="Produkttest">funkt. Eignung: Test Produkt/FA</testProcedure>
    </actor>
...
<!-- A_27091 -->
<requirement conformance="SHALL" key="IG-TIFLOW-ERP-A283" title="TI-Flow-Fachdienst - Zugriffsberechtigung schreiben - Prüfung Zugriffscode" version="0">
    <meta lockversion="false"/>
    <actor name="TI-Flow_FD" description="TI-Flow-Fachdienst">
        <testProcedure id="Produkttest">funkt. Eignung: Test Produkt/FA</testProcedure>
    </actor>
...
<!-- A_27092 -->
<requirement conformance="SHALL" key="IG-TIFLOW-ERP-A284" title="TI-Flow-Fachdienst - Zugriffsberechtigung schreiben - Löschen bestehender Zugriffsberechtigung" version="0">
    <meta lockversion="false"/>
    <actor name="TI-Flow_FD" description="TI-Flow-Fachdienst">
        <testProcedure id="Produkttest">funkt. Eignung: Test Produkt/FA</testProcedure>
    </actor>
...
<!-- A_27093 -->
<requirement conformance="SHALL" key="IG-TIFLOW-ERP-A285" title="TI-Flow-Fachdienst - Zugriffsberechtigung schreiben - Neue Zugriffsberechtigung speichern" version="0">
    <meta lockversion="false"/>
    <actor name="TI-Flow_FD" description="TI-Flow-Fachdienst">
        <testProcedure id="Produkttest">funkt. Eignung: Test Produkt/FA</testProcedure>
    </actor>
...
<!-- A_27094 -->
<requirement conformance="SHALL" key="IG-TIFLOW-ERP-A286" title="TI-Flow-Fachdienst - Zugriffsberechtigung schreiben - Response" version="0">
    <meta lockversion="false"/>
    <actor name="TI-Flow_FD" description="TI-Flow-Fachdienst">
        <testProcedure id="Produkttest">funkt. Eignung: Test Produkt/FA</testProcedure>
    </actor>
...
<!-- A_27083 -->
<requirement conformance="SHALL" key="IG-TIFLOW-ERP-A287" title="TI-Flow-Fachdienst - Zugriffsberechtigung - periodische Bereinigung" version="0">
    <meta lockversion="false"/>
    <actor name="TI-Flow_FD" description="TI-Flow-Fachdienst">
