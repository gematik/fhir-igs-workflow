...
<!-- A_27070 -->
<requirement conformance="SHALL" key="IG-TIFLOW-ERP-A263" title="TI-Flow-Fachdienst - Task schließen - EU - Prüfung Einwilligung für KVNR" version="0">
    <meta lockversion="false"/>
    <actor name="TI-Flow_FD" description="TI-Flow-Fachdienst">
        <testProcedure id="Produkttest">funkt. Eignung: Test Produkt/FA</testProcedure>
    </actor>
...
<!-- A_27071 -->
<requirement conformance="SHALL" key="IG-TIFLOW-ERP-A264" title="TI-Flow-Fachdienst - Task schließen - EU - Prüfung Zugriffsberechtigung" version="0">
    <meta lockversion="false"/>
    <actor name="TI-Flow_FD" description="TI-Flow-Fachdienst">
        <testProcedure id="Produkttest">funkt. Eignung: Test Produkt/FA</testProcedure>
    </actor>
...
<!-- A_27072 -->
<requirement conformance="SHALL" key="IG-TIFLOW-ERP-A265" title="TI-Flow-Fachdienst - Task schließen - EU - Statusprüfung" version="0">
    <meta lockversion="false"/>
    <actor name="TI-Flow_FD" description="TI-Flow-Fachdienst">
        <testProcedure id="Produkttest">funkt. Eignung: Test Produkt/FA</testProcedure>
    </actor>
...
<!-- A_27074 -->
<requirement conformance="SHALL" key="IG-TIFLOW-ERP-A266" title="TI-Flow-Fachdienst - Task schließen - EU - Zeitstempel MedicationDispense" version="0">
    <meta lockversion="false"/>
    <actor name="TI-Flow_FD" description="TI-Flow-Fachdienst">
        <testProcedure id="Produkttest">funkt. Eignung: Test Produkt/FA</testProcedure>
    </actor>
...
<!-- A_27075 -->
<requirement conformance="SHALL" key="IG-TIFLOW-ERP-A267" title="TI-Flow-Fachdienst - Task schließen - EU - Status beenden" version="0">
    <meta lockversion="false"/>
    <actor name="TI-Flow_FD" description="TI-Flow-Fachdienst">
        <testProcedure id="Produkttest">funkt. Eignung: Test Produkt/FA</testProcedure>
    </actor>
...
<!-- A_28206 -->
<requirement conformance="SHALL" key="IG-TIFLOW-ERP-A268" title="TI-Flow-Fachdienst - Task schließen - EU - Push Notification Versicherter" version="0">
    <meta lockversion="false"/>
    <actor name="TI-Flow_FD" description="TI-Flow-Fachdienst">
        <testProcedure id="Produkttest">funkt. Eignung: Test Produkt/FA</testProcedure>
    </actor>
