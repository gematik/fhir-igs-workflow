...
* insert LegacyMeta(StructureDefinition, GEM_ERP_EX_LastMedicationDispense)
...
* . ^definition = "Dieses Feld ermöglicht es der TI-Flow-FdV, dem Benutzer anzuzeigen, dass ein Medikament abgegeben wurde, bevor es von der Apotheke abgeschlossen wurde."
