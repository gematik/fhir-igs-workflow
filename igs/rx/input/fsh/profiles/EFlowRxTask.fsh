...
* extension contains EFlowRxPrescriptionTypeExtension named flowType 1..1 MS
and EFlowRxAcceptDateExtension named acceptDate 0..1 MS
and EFlowRxExpiryDateExtension named expiryDate 0..1 MS
and EFlowRxLastMedicationDispenseExtension named lastMedicationDispense 0..1
...
* performerType.coding from EFlowRxOrganizationTypeVS (required)
...
* input[ePrescription] 0..1 MS
  ...
  * value[x] only Reference(EFlowRxBinary)
  * type.coding 1..1
  * type.coding from EFlowRxDocumentTypeVS (required)
    * system 1..1
    * code 1..1
    * code = #1 (exactly)
...
* output[receipt] 0..1 MS
  * value[x] only Reference(EFlowRxBundle)
  * type.coding 1..1
  * type.coding from EFlowRxDocumentTypeVS (required)
    * system 1..1
    * code 1..1
