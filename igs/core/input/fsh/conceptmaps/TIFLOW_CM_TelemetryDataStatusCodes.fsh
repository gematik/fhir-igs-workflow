...
* group[=].element[28].code = #TIFLOW_SECRET_MISMATCH
* group[=].element[28].target[0].code = #79228
* group[=].element[28].target[0].equivalence = #equivalent
* group[=].element[29].code = #TIFLOW_SIGNATURE_AUTHOREDON_MISMATCH
* group[=].element[29].target[0].code = #79229
* group[=].element[29].target[0].equivalence = #equivalent
* group[=].element[30].code = #TIFLOW_SIGNATURE_INVALID
* group[=].element[30].target[0].code = #79230
* group[=].element[30].target[0].equivalence = #equivalent
* group[=].element[31].code = #TIFLOW_SIGNATURE_INVALID_ISSUING_ROLE
* group[=].element[31].target[0].code = #79231
* group[=].element[31].target[0].equivalence = #equivalent
* group[=].element[32].code = #TIFLOW_SIGNATURE_NO_OCSP_RESPONSE
* group[=].element[32].target[0].code = #79232
* group[=].element[32].target[0].equivalence = #equivalent
* group[=].element[33].code = #TIFLOW_TASK_DELETED
* group[=].element[33].target[0].code = #79233
* group[=].element[33].target[0].equivalence = #equivalent
* group[=].element[34].code = #TIFLOW_TASK_EXPIRED
* group[=].element[34].target[0].code = #79234
* group[=].element[34].target[0].equivalence = #equivalent
* group[=].element[35].code = #TIFLOW_TASK_ID_REQUIRED
* group[=].element[35].target[0].code = #79235
* group[=].element[35].target[0].equivalence = #equivalent
* group[=].element[36].code = #TIFLOW_TASK_NOT_FOUND
* group[=].element[36].target[0].code = #79236
* group[=].element[36].target[0].equivalence = #equivalent
* group[=].element[37].code = #TIFLOW_TASK_REQUIRED
* group[=].element[37].target[0].code = #79237
* group[=].element[37].target[0].equivalence = #equivalent
* group[=].element[38].code = #TIFLOW_TASK_STATUS_MISMATCH
* group[=].element[38].target[0].code = #79238
* group[=].element[38].target[0].equivalence = #equivalent
* group[=].element[39].code = #TIFLOW_POPP_TOKEN_INVALID
* group[=].element[39].target[0].code = #79273
* group[=].element[39].target[0].equivalence = #equivalent
* group[=].element[40].code = #TIFLOW_INTERNAL_ERROR
* group[=].element[40].target[0].code = #79274
* group[=].element[40].target[0].equivalence = #equivalent
* group[=].element[40].code = #TIFLOW_TIMEOUT
* group[=].element[41].target[0].code = #79275
* group[=].element[41].target[0].equivalence = #equivalent
* group[=].element[42].code = #TIFLOW_BLOCKED_FEATURE
* group[=].element[42].target[0].code = #79268
* group[=].element[42].target[0].equivalence = #equivalent
* group[=].element[43].code = #TIFLOW_BLOCKED_FLOWTYPE
* group[=].element[43].target[0].code = #79270
* group[=].element[43].target[0].equivalence = #equivalent
* group[=].element[44].code = #TIFLOW_NOT_SUPPORTED
* group[=].element[44].target[0].code = #79276
...
* group[=].element[3].code = #MSG_BAD_FORMAT
* group[=].element[3].target[0].code = #79265
* group[=].element[3].target[0].equivalence = #equivalent
* group[=].element[4].code = #MSG_BAD_SYNTAX
* group[=].element[4].target[0].code = #79266
* group[=].element[4].target[0].equivalence = #equivalent
