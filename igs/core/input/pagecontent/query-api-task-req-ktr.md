...
<requirement conformance="SHALL" key="IG-TIFLOW-CORE-368" title="CS Kostenträger: Recovery Secret - Statusrequest" version="0">
...
<!-- A_19292 -->
<requirement conformance="SHALL" key="IG-TIFLOW-CORE-368" title="CS Kostenträger: Quittung erneut abrufen - Statusrequest" version="0">
  <meta lockversion="false"/>
  <actor name="CS_E-Rezept_KTR">
    <testProcedure id="Herstellererklärung"/>
  </actor>
