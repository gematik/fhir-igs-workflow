...
<requirement conformance="SHALL" key="IG-PRE-TIFLOW-CORE-215" title="CS Kostenträger: Recovery Secret - Statusrequest" version="0">
...
<!-- A_19292 -->
<requirement conformance="SHALL" key="IG-PRE-TIFLOW-CORE-216" title="CS Kostenträger: Quittung erneut abrufen - Statusrequest" version="0">
  <meta lockversion="false"/>
  <actor name="CS_E-Rezept_KTR">
    <testProcedure id="Herstellererklärung"/>
  </actor>
