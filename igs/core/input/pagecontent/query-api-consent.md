...
- [Client-Anforderungen zur Consent-Query](./query-api-consent-req-fdv.html): Anforderungen an den Client des E-Rezept-Fachdienstes zur Nutzung der Schnittstelle.
