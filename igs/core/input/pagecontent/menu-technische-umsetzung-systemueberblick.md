<!-- TI-Flow-26_2 BSI_21 -->
Der TI-Flow-Fachdienst verwaltet Verordnungen (bspw. E-Rezepte) in der Telematikinfrastruktur als ein zentraler Ressourcenserver auf Basis des FHIR-Standards mit einer RESTful API. Die Verordnungen werden dabei über eine eindeutige Ressourcen-ID adressiert. Zusätzlich koordiniert der TI-Flow-Fachdienst die Statusübergänge der Workflows zu Verordnungen und protokolliert alle Zugriffe auf die Daten zu einer Verordnung für den Versicherten. Für einen Nachrichtenaustausch zwischen Apotheken und Versicherte zur Belieferung von Verordnungen ist eine Kommunikation über den TI-Flow-Fachdienst möglich.
