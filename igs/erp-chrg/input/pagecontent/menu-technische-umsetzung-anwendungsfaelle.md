...
<!-- A_19443 -->
<requirement conformance="SHALL" key="IG-TIFLOW-CHRG-A33" title="TI-Flow-FdV: Abrechnungsinformationen - Anwendungsfälle" version="0">
    <meta lockversion="false"/>
    <actor name="TI-Flow_FdV" description="TI-Flow-Frontend des Versicherten">
        <testProcedure id="Herstellererklärung">funkt. Eignung: Herstellererklärung</testProcedure>
    </actor>
    Das TI-Flow-FdV MUSS, wenn es Abrechnungsinformationen für PKV-Versicherte unterstützt, die Anwendungsfälle
    <ul>
...
<requirement conformance="SHALL" key="IG-TIFLOW-CHRG-A34" title="PS abgebende LEI: Abrechnungsinformationen - Anwendungsfälle" version="0">
    <meta lockversion="false"/>
