Diese Seite beschreibt Anforderungen an ein AVS zur Nutzung der `Communication`-Endpunkte für "Bereitstellung von Abrechnungsinformationen für PKV-Versicherte".

### Anforderungen aus der Core Spezifikation

Für diese Schnittstelle gelten die Anforderungen aus der [Core-Spezifikation](https://gematik.de/fhir/tiflow/{{ site.data.constants.tiflow_core_version }}/query-api-communication-req-avs.html)
