...
Er wird [hier](./query-api-chargeitem-req-ps-post.html) im Detail beschreiben.
...
Er wird [hier](./query-api-chargeitem-req-ps-get-id.html) im Detail beschreiben.
...
Er wird [hier](./query-api-chargeitem-req-ps-put.html) im Detail beschreiben.