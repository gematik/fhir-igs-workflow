...
// Test-IDs
// DAV
Alias: $UUID_DAV_PKV_AbgabedatenComposition = 00000000-0000-4000-8000-000000000001
Alias: $URN_DAV_PKV_AbgabedatenComposition = urn:uuid:00000000-0000-4000-8000-000000000001
Alias: $UUID_DAV_PKV_AbgabedatenApotheke = 00000000-0000-4000-8000-000000000002
Alias: $URN_DAV_PKV_AbgabedatenApotheke = urn:uuid:00000000-0000-4000-8000-000000000002
Alias: $UUID_DAV_PKV_Abgabeinformationen = 00000000-0000-4000-8000-000000000003
Alias: $URN_DAV_PKV_Abgabeinformationen = urn:uuid:00000000-0000-4000-8000-000000000003
Alias: $UUID_DAV_PKV_Abrechnungszeilen = 00000000-0000-4000-8000-000000000004
Alias: $URN_DAV_PKV_Abrechnungszeilen = urn:uuid:00000000-0000-4000-8000-000000000004

// GEM-ERP-Bundle
Alias: $UUID_GEM_ERP_Composition = 00000000-0000-4000-8000-000000000005
Alias: $URN_GEM_ERP_Composition = urn:uuid:00000000-0000-4000-8000-000000000005
Alias: $UUID_GEM_ERP_Device = 00000000-0000-4000-8000-000000000006
Alias: $URN_GEM_ERP_Device = urn:uuid:00000000-0000-4000-8000-000000000006
Alias: $UUID_GEM_ERP_Digest = 00000000-0000-4000-8000-000000000007
Alias: $URN_GEM_ERP_Digest = urn:uuid:00000000-0000-4000-8000-000000000007
Alias: $UUID_GEM_ERP_Signature = 00000000-0000-4000-8000-000000000008
Alias: $URN_GEM_ERP_Signature = urn:uuid:00000000-0000-4000-8000-000000000008

Alias: $UUID_KBV_PR_ERP_Bundle = 00000000-0000-4000-8000-000000000009
Alias: $URN_KBV_PR_ERP_Bundle = urn:uuid:00000000-0000-4000-8000-000000000009
Alias: $UUID_KBV_PR_ERP_Bundle_with_Signature = 00000000-0000-4000-8000-0000000000010
Alias: $URN_KBV_PR_ERP_Bundle_with_Signature = urn:uuid:00000000-0000-4000-8000-0000000000010

Alias: $UUID_DAV_PKV_AbgabedatenBundle = 00000000-0000-4000-8000-000000000011
Alias: $URN_DAV_PKV_AbgabedatenBundle = urn:uuid:00000000-0000-4000-8000-000000000011
Alias: $UUID_DAV_PKV_AbgabedatenBundle_with_Signature = 00000000-0000-4000-8000-0000000000012
Alias: $URN_DAV_PKV_AbgabedatenBundle_with_Signature = urn:uuid:00000000-0000-4000-8000-0000000000012

Alias: $UUID_GEM_ERP_Bundle = 00000000-0000-4000-8000-000000000013
Alias: $URN_GEM_ERP_Bundle = urn:uuid:00000000-0000-4000-8000-000000000013
