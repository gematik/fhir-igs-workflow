...
* extension[responseInfo][+]
  * extension[statusCode].valueString = "400"
  * extension[description].valueString = "Invalid request format"
  * extension[responseType].valueString = "TIFlowOperationOutcome"
...
* extension[responseInfo][+]
  ...
  * extension[description].valueString = "Identity mismatch: Access token id does not match FHIR data (Telematik-ID / KVNR)"
  * extension[responseType].valueString = "TIFlowOperationOutcome"
