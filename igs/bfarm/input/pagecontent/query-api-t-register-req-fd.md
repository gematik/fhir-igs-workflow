...
<!-- A_28933 -->
<requirement conformance="SHALL" key="" title="TI-Flow-Fachdienst - BfArM - Prüfung der Validierungsstufe des TLS-Server-Zertifikats" version="0">
    <meta lockversion="false"/>
    <actor name="TI-Flow_FD" description="TI-Flow-Fachdienst">
        <testProcedure id="Produktgutachten">Sich.techn. Eignung: Produktgutachten</testProcedure>
    </actor>
    Der TI-Flow-Fachdienst MUSS beim Aufbau einer HTTPS-Verbindung zum BfArM Webdienst prüfen, dass das TLS-Server-Zertifikat im Erweiterungsfeld Certificate Policies (OID 2.5.29.32) einen der folgenden Policy Identifier enthält:
    <ul>
      <li>2.23.140.1.2.2 (OV - organization-validated)</li>
      <li>2.23.140.1.1 (EV - extended-validation)</li>
    </ul>
    und bei Fehlen die Verbindung abbrechen, um eine sichere Validierungsstufe des TLS-Server-Zertifikats zu gewährleisten.
</requirement>
