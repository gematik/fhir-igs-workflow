...
<!-- A_27819 -->
<requirement conformance="SHALL" title="Anbieter E-Rezept Fachdienst - BfArM - Registrierung für Client Credentials am BfArM Webdienst">
...
<!-- A_27820 -->
<requirement conformance="SHALL" title="E-Rezept-Fachdienst - BfArM - Prüfung Gültigkeit AccessToken">
    <meta lockversion="false"/>
    <actor name="E-Rezept-Fachdienst">
        <testProcedure id="Produkttest"/>
    </actor>
...
<!-- A_27821 -->
<requirement conformance="SHALL" title="E-Rezept-Fachdienst - BfArM - Beziehen des AccessTokens">
    <meta lockversion="false"/>
    <actor name="E-Rezept-Fachdienst">
        <testProcedure id="Produkttest"/>
    </actor>
...
<!-- A_27822 -->
<requirement conformance="SHALL" title="E-Rezept-Fachdienst - BfArM - AccessToken für Zugriff auf den BfArM Webdienst">
    <meta lockversion="false"/>
    <actor name="E-Rezept-Fachdienst">
        <testProcedure id="Produkttest"/>
    </actor>
...
<!-- A_27882 -->
<requirement conformance="SHALL" title="E-Rezept-Fachdienst - BfArM - Lokalisierung Konfigurationsparameter BfArM_Domain">
    <meta lockversion="false"/>
    <actor name="E-Rezept-Fachdienst">
        <testProcedure id="Produkttest"/>
    </actor>
...
<!-- A_27817 -->
<requirement conformance="SHALL" title="E-Rezept-Fachdienst - BfArM - Lokalisierung des BfArM Webdienstes">
    <meta lockversion="false"/>
    <actor name="E-Rezept-Fachdienst">
        <testProcedure id="Produkttest"/>
    </actor>
...
<!-- A_27823 -->
<requirement conformance="SHALL" title="E-Rezept-Fachdienst - BfArM - Flowtype 166">
    <meta lockversion="false"/>
    <actor name="E-Rezept-Fachdienst">
        <testProcedure id="Produkttest"/>
    </actor>
...
<!-- A_27824 -->
<requirement conformance="SHALL" title="E-Rezept-Fachdienst - BfArM - asynchrone Bereitstellung und Übermittlung">
    <meta lockversion="false"/>
    <actor name="E-Rezept-Fachdienst">
        <testProcedure id="Produkttest"/>
    </actor>
...
<!-- A_27825 -->
<requirement conformance="SHALL" title="E-Rezept-Fachdienst - BfArM - Suche nach Apothekendaten">
    <meta lockversion="false"/>
    <actor name="E-Rezept-Fachdienst">
        <testProcedure id="Produkttest"/>
    </actor>
...
<!-- A_27826 -->
<requirement conformance="SHALL" title="E-Rezept-Fachdienst - BfArM - Erzeugen digitaler Durchschlag E-T-Rezept">
    <meta lockversion="false"/>
    <actor name="E-Rezept-Fachdienst">
        <testProcedure id="Produkttest"/>
    </actor>
...
<!-- A_27827 -->
<requirement conformance="SHALL" title="E-Rezept-Fachdienst - BfArM - Anwendungsfall Übertragen des digitalen Durchschlags">
    <meta lockversion="false"/>
    <actor name="E-Rezept-Fachdienst">
        <testProcedure id="Produkttest"/>
    </actor>
    ...
    <tr>
      ...
      <td>
        <ul>
          <li>Dem E-Rezept-Fachdienst liegen Client Credentials des BfArM zur Authentifizierung vor</li>
...
<!-- A_27828 -->
<requirement conformance="SHALL" title="E-Rezept-Fachdienst - BfArM - Übertragen des digitalen Durchschlags">
    <meta lockversion="false"/>
    <actor name="E-Rezept-Fachdienst">
        <testProcedure id="Produkttest"/>
    </actor>
...
<!-- A_27830 -->
<requirement conformance="SHALL" title="E-Rezept-Fachdienst - BfArM - Fehlerbehandlung - Reaktion auf Scheitern des Operationaufrufs">
    <meta lockversion="false"/>
    <actor name="E-Rezept-Fachdienst">
        <testProcedure id="Produkttest"/>
    </actor>
...
<!-- A_27831 -->
<requirement conformance="SHALL" title="E-Rezept-Fachdienst - BfArM - Fehlerbehandlung - Protokollierung struktureller Fehler">
    <meta lockversion="false"/>
    <actor name="E-Rezept-Fachdienst">
        <testProcedure id="Produkttest"/>
    </actor>
