...
<ul>
<li>keine Angaben zum Versicherten (gesetzlich verboten),</li>
<li>keine Angaben zum ausstellenden Leistungserbringer (inkl. Signatur, da vom BfArM nicht benötigt), </li>
<li>Informationen zur Kontaktaufnahme mit der abgebenden Apotheke (vom BfArM benötigt) übertragen werden.</li>
</ul>
