...
<!-- A_27551 -->
<requirement conformance="SHALL" key="IG-TIFLOW-EU-78" title="E-Rezept-Fachdienst -Task markieren -Versicherter - FHIR-Validierung Parameters" version="0">
...
<!-- A_28500 -->
<requirement conformance="SHALL" key="IG-TIFLOW-EU-79" title="E-Rezept-Fachdienst -Task markieren -Versicherter - nur einlösbare E-Rezepte" version="0">
    <meta lockversion="false"/>
    <actor name="eRp_FD">
        <testProcedure id="Produkttest"/>
    </actor>
...
<!-- A_27552 -->
<requirement conformance="SHALL" key="IG-TIFLOW-EU-80" title="E-Rezept-Fachdienst -Task markieren -Versicherter - Änderung Markierung Task Ressource" version="0">
    <meta lockversion="false"/>
    <actor name="eRp_FD">
        <testProcedure id="Produkttest"/>
    </actor>
