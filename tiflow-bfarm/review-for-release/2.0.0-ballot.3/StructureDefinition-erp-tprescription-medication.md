# E-T-Rezept Medication - Implementation Guide TIFlow - Datenaustausch BfArM Webdienst v2.0.0-ballot.3
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/tiflow-bfarm/StructureDefinition/erp-tprescription-medication | *Version*:2.0.0-ballot.3 |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/de.gematik.tiflow.bfarm|current/StructureDefinition/StructureDefinition-erp-tprescription-medication.json)
