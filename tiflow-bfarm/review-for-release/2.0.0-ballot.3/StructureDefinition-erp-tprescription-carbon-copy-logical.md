# Logisches Modell digitaler Durchschlag E-T-Rezept - Implementation Guide TIFlow - Datenaustausch BfArM Webdienst v2.0.0-ballot.3
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/tiflow-bfarm/StructureDefinition/erp-tprescription-carbon-copy-logical | *Version*:2.0.0-ballot.3 |
| Draft as of 2026-08-25 | *Computable Name*:ERP_TPrescription_CarbonCopy_Logical |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/de.gematik.tiflow.bfarm|current/StructureDefinition/StructureDefinition-erp-tprescription-carbon-copy-logical.json)
...
```json
{
  ...
  "status" : "draft",
  "date" : "2026-08-25T08:17:09+00:00",
