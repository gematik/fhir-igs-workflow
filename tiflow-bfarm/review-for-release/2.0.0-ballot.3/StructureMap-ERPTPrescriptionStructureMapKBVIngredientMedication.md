# E-T-Rezept Structure Map for KBV Ingredient Medication - Implementation Guide TIFlow - Datenaustausch BfArM Webdienst v2.0.0-ballot.3
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/tiflow-bfarm/StructureMap/ERPTPrescriptionStructureMapKBVIngredientMedication | *Version*:2.0.0-ballot.3 |
...
```json
{
  ...
  "url" : "https://gematik.de/fhir/tiflow-bfarm/StructureMap/ERPTPrescriptionStructureMapKBVIngredientMedication",
