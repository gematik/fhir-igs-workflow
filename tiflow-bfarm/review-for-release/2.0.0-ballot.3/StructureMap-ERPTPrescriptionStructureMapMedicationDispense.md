# E-T-Rezept Structure Map for MedicationDispense - Implementation Guide TIFlow - Datenaustausch BfArM Webdienst v2.0.0-ballot.3
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/tiflow-bfarm/StructureMap/ERPTPrescriptionStructureMapMedicationDispense | *Version*:2.0.0-ballot.3 |
...
```json
{
  ...
  "url" : "https://gematik.de/fhir/tiflow-bfarm/StructureMap/ERPTPrescriptionStructureMapMedicationDispense",
