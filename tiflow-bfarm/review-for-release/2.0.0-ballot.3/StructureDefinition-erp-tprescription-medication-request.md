# E-T-Rezept Medication Request - Implementation Guide TIFlow - Datenaustausch BfArM Webdienst v2.0.0-ballot.3
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/tiflow-bfarm/StructureDefinition/erp-tprescription-medication-request | *Version*:2.0.0-ballot.3 |
...
| `kbvMedicationRequest.medication` | `bfarmMedicationRequest.medication` | Transformiert die Medication-Referenz zu urn:uuid Format→ erstellt neues Reference |
