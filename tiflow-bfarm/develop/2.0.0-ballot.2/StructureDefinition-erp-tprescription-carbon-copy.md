# Digitaler Durchschlag T-Rezept - Implementation Guide TIFlow - Datenaustausch BfArM Webdienst v2.0.0-ballot.2
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/tiflow-bfarm/StructureDefinition/erp-tprescription-carbon-copy | *Version*:2.0.0-ballot.2 |
| Draft as of 2026-06-30 | *Computable Name*:ERP_TPrescription_CarbonCopy |
...
|   | `CarbonCopy.meta.profile` | Setzt das meta.profile des digitalen Durchschlags T-Rezept→ setzt URL 'https://gematik.de/fhir/tiflow/bfarm/StructureDefinition/erp-tprescription-carbon-copy | 1.1' |
...
| `bundle.entry.resource.resource [Typ: Task]` | `parameter.name` | Extrahiert die E-Rezept-ID aus dem Task und erstellt den prescriptionId Parameter→ setzt Wert 'prescriptionId' |   |
| `bundle.entry.resource.resource [Typ: Task]` | `value` | Extrahiert die E-Rezept-ID aus dem Task und erstellt den prescriptionId Parameter→ erstellt neues Identifier |   |
| `bundle.entry.resource.resource [Typ: Task]` | **(wird bestimmt durch Kontext)** | Mappt Task-Informationen auf Identifier für die Rezept-IDVerwendet Mapping:[Task](./StructureMap-ERPTPrescriptionStructureMapTask.md) |   |
| `bundle.entry.resource.resource [Typ: MedicationRequest]` | `parameter.name` | Erstellt den medicationRequest Parameter für Verschreibungsdetails→ setzt Wert 'medicationRequest' |   |
| `bundle.entry.resource.resource [Typ: MedicationRequest]` | `parameter.resource` | Transformiert KBV-MedicationRequest in BfArM MedicationRequest Format→ erstellt neues MedicationRequest |   |
| `bundle.entry.resource.resource [Typ: MedicationRequest]` | **(wird bestimmt durch Kontext)** | Führt die detaillierte MedicationRequest-Transformation durchVerwendet Mapping:[MedicationRequest](./StructureMap-ERPTPrescriptionStructureMapMedicationRequest.md) |   |
...
| `bundle.entry.resource.resource [Typ: Bundle]` | `parameter.name` | Identifiziert VZD SearchSet Bundle für Apothekeninformationen→ setzt Wert 'dispenseOrganization' |   |
| `bundle.entry.resource.resource [Typ: Bundle]` | `parameter.resource` | Transformiert VZD SearchSet in BfArM Organization Format für die abgebende Apotheke→ erstellt neues Organization |   |
| `bundle.entry.resource.resource [Typ: Bundle]` | **(wird bestimmt durch Kontext)** | Führt die detaillierte Organization-Transformation durchVerwendet Mapping:[Organization](./StructureMap-ERPTPrescriptionStructureMapOrganization.md) |   |
...
| `bundle.entry.resource.resource [Typ: MedicationDispense]` | `parameter.part.name` | Bündelt MedicationDispense und zugehörige Medication unter dispenseInformation→ setzt Wert 'dispenseInformation' |   |
...
| `bundle.entry.resource.resource [Typ: MedicationDispense]` | `part.part` | Bündelt MedicationDispense und zugehörige Medication unter dispenseInformation |   |
| `bundle.entry.resource.resource [Typ: MedicationDispense]` | `part.name.name` | Transformiert gematik MedicationDispense in BfArM MedicationDispense Format→ setzt Wert 'medicationDispense' |   |
| `bundle.entry.resource.resource [Typ: MedicationDispense]` | `part.name.resource` | Transformiert gematik MedicationDispense in BfArM MedicationDispense Format→ erstellt neues MedicationDispense |   |
| `bundle.entry.resource.resource [Typ: MedicationDispense]` | **(wird bestimmt durch Kontext)** | Führt die detaillierte MedicationDispense-Transformation durchVerwendet Mapping:[MedicationDispense](./StructureMap-ERPTPrescriptionStructureMapMedicationDispense.md) |   |
| `bundle.entry.resource.resource [Typ: MedicationDispense]` | `part.name.name` | Findet die vom MedicationDispense referenzierte Medication und transformiert sie in BfArM Format→ setzt Wert 'medication' |   |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/de.gematik.tiflow.bfarm|current/StructureDefinition/StructureDefinition-erp-tprescription-carbon-copy.json)
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Medication",
        "profile" : ["https://gematik.de/fhir/tiflow-bfarm/StructureDefinition/erp-tprescription-medication"]
      }]
    },
    {
