# E-T-Rezept Organization - Implementation Guide TIFlow - Datenaustausch BfArM Webdienst v2.0.0-ballot.2
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/tiflow-bfarm/StructureDefinition/erp-tprescription-organization | *Version*:2.0.0-ballot.2 |
| Draft as of 2026-06-30 | *Computable Name*:ERP_TPrescription_Organization |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/de.gematik.tiflow.bfarm|current/StructureDefinition/StructureDefinition-erp-tprescription-organization.json)
...
```json
{
  ...
  "url" : "https://gematik.de/fhir/tiflow-bfarm/StructureDefinition/erp-tprescription-organization",
