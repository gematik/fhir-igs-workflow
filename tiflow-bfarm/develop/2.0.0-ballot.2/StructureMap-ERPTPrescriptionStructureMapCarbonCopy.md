# E-T-Rezept Structure Map for CarbonCopy - Implementation Guide TIFlow - Datenaustausch BfArM Webdienst v2.0.0-ballot.2
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/tiflow-bfarm/StructureMap/ERPTPrescriptionStructureMapCarbonCopy | *Version*:2.0.0-ballot.2 |
| Draft as of 2026-06-30 | *Computable Name*:ERPTPrescriptionStructureMapCarbonCopy |
...
```json
{
  ...
  "url" : "https://gematik.de/fhir/tiflow-bfarm/StructureMap/ERPTPrescriptionStructureMapCarbonCopy",
  ...
  "import" : ["https://gematik.de/fhir/tiflow-bfarm/StructureMap/ERPTPrescriptionStructureMapMedicationDispense",
  "https://gematik.de/fhir/tiflow-bfarm/StructureMap/ERPTPrescriptionStructureMapMedicationRequest",
  "https://gematik.de/fhir/tiflow-bfarm/StructureMap/ERPTPrescriptionStructureMapOrganization",
  "https://gematik.de/fhir/tiflow-bfarm/StructureMap/ERPTPrescriptionStructureMapTask",
  "https://gematik.de/fhir/tiflow-bfarm/StructureMap/ERPTPrescriptionStructureMapMedication"],
  "group" : [{
            ...
            "rule" : [{
              ...
              "rule" : [{
                ...
                "source" : [{
                  ...
                  "condition" : "resource.ofType(Medication).where(id=%srcMedicationRequestId.resource.medication.reference.replace('urn:uuid:', '').split('/').last())"
                }],
                "target" : [{
                  "context" : "tgtRxPrescriptionPartMed",
                  "contextType" : "variable",
