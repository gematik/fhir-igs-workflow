...
```json
{
  ...
  "status" : "draft",
  "date" : "2026-02-26T14:56:48+00:00",
  ...
  "packageId" : "de.gematik.workflow.core",
  "license" : "CC0-1.0",
  "fhirVersion" : ["4.0.1"],
  "dependsOn" : [{
    "id" : "hl7tx",
  ...
  "definition" : {
    ...
    },
    {
      ...
      {
        "url" : "value",
        "valueString" : "https://gematik.de/fhir/workflow/core/history.html"
      }],
      "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
    },
    {
    ...
    "page" : {
      ...
      },
      {
        "extension" : [{
          "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-page-name",
          "valueUrl" : "data-security.html"
        }],
        "nameUrl" : "data-security.html",
