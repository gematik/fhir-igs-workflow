# Communication message sent by pharmacy to patient in response to a previous ChargeItem-related message - TIFlow - Abrechnungsinformationen v2.0.0-ballot.1
