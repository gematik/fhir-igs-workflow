# GEM_ERPCHRG_EX_MarkingFlag - TIFlow - Abrechnungsinformationen v2.0.0-ballot.1
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/erpchrg/StructureDefinition/GEM_ERPCHRG_EX_MarkingFlag | *Version*:2.0.0-ballot.1 |
| Active as of 2028-04-01 | *Computable Name*:GEM_ERPCHRG_EX_MarkingFlag |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/de.gematik.tiflow.chargeitem|current/StructureDefinition/GEM-ERPCHRG-EX-MarkingFlag)
