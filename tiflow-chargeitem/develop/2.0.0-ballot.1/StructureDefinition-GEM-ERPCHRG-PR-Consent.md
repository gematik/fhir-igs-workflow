# GEM_ERPCHRG_PR_Consent - TIFlow - Abrechnungsinformationen v2.0.0-ballot.1
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/erpchrg/StructureDefinition/GEM_ERPCHRG_PR_Consent | *Version*:2.0.0-ballot.1 |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/de.gematik.tiflow.chargeitem|current/StructureDefinition/GEM-ERPCHRG-PR-Consent)
