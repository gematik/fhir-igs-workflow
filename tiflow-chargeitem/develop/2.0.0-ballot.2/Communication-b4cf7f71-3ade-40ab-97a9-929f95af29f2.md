# Communication message sent by patient to pharmacy to request the change of an existing ChargeItem by providing the AccessCode - Implementation Guide TIFlow - Abrechnungsinformationen v2.0.0-ballot.2
