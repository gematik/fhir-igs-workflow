# Consent to store digital ChargeItem - Implementation Guide TIFlow - Abrechnungsinformationen v2.0.0-ballot.2
...
Profile: [GEM_ERPCHRG_PR_Consent](StructureDefinition-GEM-ERPCHRG-PR-Consent.md)
