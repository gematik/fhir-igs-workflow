# AVS-Anforderungen: ChargeItem-Query - Implementation Guide TIFlow - Abrechnungsinformationen v2.0.0-ballot.2
...
funkt. Eignung: KonformitätsbestätigungDas PS der abgebenden LEI MUSS im Anwendungsfall "Abrechnungsinformation bereitstellen" die HTTP-Operation POST /ChargeItem/ des TI-Flow-Fachdienstes mit
...
funkt. Eignung: HerstellererklärungDas PS der abgebenden LEI MUSS es dem Nutzer ermöglichen, die Abrechnungsinformation zu einem E-Rezept zum Ändern auf dem TI-Flow-Fachdienst auszuwählen.
...
funkt. Eignung: KonformitätsbestätigungDas PS abgebende LEI MUSS im Anwendungsfall "PKV-Abgabedatensatz ändern" die HTTP-Operation PUT /ChargeItem/<id>/ des TI-Flow-Fachdienstes mit
...
funkt. Eignung: Test Produkt/FADas PS abgebende LEI MUSS im Anwendungsfall "Abrechnungsinformation abrufen" die HTTP-Operation GET /ChargeItem/<id> des TI-Flow-Fachdienstes mit
* Prescription-ID in URL <id>
* AccessCode in URL-Parameter ?ac=
ausführen.
