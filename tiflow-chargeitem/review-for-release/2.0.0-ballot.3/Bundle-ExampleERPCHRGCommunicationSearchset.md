# Communication searchset response for ERP-CHRG - Implementation Guide TIFlow - Abrechnungsinformationen v2.0.0-ballot.3
...
```json
{
  ...
  "entry" : [{
    "fullUrl" : "https://erp-ref.example.org/Communication/Communication_ChargChangeRequest_Response",
    "resource" : {
