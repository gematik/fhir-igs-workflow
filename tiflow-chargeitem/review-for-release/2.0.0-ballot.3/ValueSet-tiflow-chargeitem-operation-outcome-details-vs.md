# TIFLOW ChargeItem Operation Outcome Details VS - Implementation Guide TIFlow - Abrechnungsinformationen v2.0.0-ballot.3
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/tiflow-chargeitem/ValueSet/tiflow-chargeitem-operation-outcome-details-vs | *Version*:2.0.0-ballot.3 |
...
```json
{
  ...
  "url" : "https://gematik.de/fhir/tiflow-chargeitem/ValueSet/tiflow-chargeitem-operation-outcome-details-vs",
