# Example Dispense Parameters - E-Rezept für Arzneimittel v1.0.0-draft
...
```json
{
  ...
  "meta" : {
    "profile" : ["https://gematik.de/fhir/erp/StructureDefinition/eflow-rx-dispense-operation-input-parameters"]
  },
  "parameter" : [{
    "name" : "rxDispensation",
    "part" : [{
