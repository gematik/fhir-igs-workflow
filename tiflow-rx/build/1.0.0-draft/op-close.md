...
Diese Operation basiert auf der gleichnamigen Operation in der [Core-Spezifikation](https://gemspec.gematik.de/ig/fhir/1.0.0/op-close.html).
...
* [Ergänzende Server-Anforderungen zu `$close`](./op-close-req-fd.md): Anforderungen an den E-Rezept-Fachdienst zur Bereitstellung der Schnittstelle.
* [Ergänzende Anforderungen für AVS zu `$close`](./op-close-req-avs.md): Anforderungen an das AVS zur Nutzung der Schnittstelle.
