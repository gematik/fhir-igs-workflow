# Query API: Task - E-Rezept für Arzneimittel v1.0.0-test
...
* [Ergänzende Server-Anforderungen zur Task-Query](./query-api-task-fd-requirements.md): Anforderungen an den E-Rezept-Fachdienst zur Bereitstellung der Schnittstelle.
* [Ergänzende Client-Anforderungen zur Task-Query](./query-api-task-client-requirements.md): Anforderungen an den Client des E-Rezept-Fachdienstes zur Nutzung der Schnittstelle.
