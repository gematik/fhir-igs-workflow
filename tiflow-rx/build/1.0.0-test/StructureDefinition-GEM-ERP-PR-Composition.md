# GEM ERP PR Composition - E-Rezept für Arzneimittel v1.0.0-test
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/erp/StructureDefinition/GEM-ERP-PR-Composition | *Version*:1.0.0-test |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/de.gematik.tiflow-rx|current/StructureDefinition/GEM-ERP-PR-Composition)
...
```json
{
  ...
  "url" : "https://gematik.de/fhir/erp/StructureDefinition/GEM-ERP-PR-Composition",
  "version" : "1.0.0-test",
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://gematik.de/fhir/erp/StructureDefinition/GEM-ERP-EX-Beneficiary"]
      }]
    },
    {
    ...
    },
    {
      ...
      "min" : 1,
      "fixedUri" : "https://gematik.de/fhir/erp/CodeSystem/GEM-ERP-CS-DocumentType"
    },
    {
