# GEM ERP PR Communication Reply - E-Rezept für Arzneimittel v1.0.0-test
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/erp/StructureDefinition/GEM-ERP-PR-Communication-Reply | *Version*:1.0.0-test |
| Draft as of 2025-12-15 | *Computable Name*:GEM_ERP_PR_Communication_Reply |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/de.gematik.tiflow-rx|current/StructureDefinition/GEM-ERP-PR-Communication-Reply)
...
```json
{
  ...
  "url" : "https://gematik.de/fhir/erp/StructureDefinition/GEM-ERP-PR-Communication-Reply",
  "version" : "1.0.0-test",
  ...
  "abstract" : false,
  "type" : "Communication",
  "baseDefinition" : "https://gematik.de/fhir/erp/StructureDefinition/GEM-ERP-PR-Communication",
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://gematik.de/fhir/erp/StructureDefinition/GEM-ERP-EX-SupplyOptionsType"]
      }]
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://gematik.de/fhir/erp/StructureDefinition/GEM-ERP-EX-AvailabilityState"]
      }]
    },
    {
