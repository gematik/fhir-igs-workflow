# GEM ERP EX EU IS REDEEMABLE BY PROPERTIES - E-Rezept für Arzneimittel v1.0.0-test
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/erp/StructureDefinition/eflow-rx-eu-is-redeemable-by-properties-extension | *Version*:1.0.0-test |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/de.gematik.tiflow-rx|current/StructureDefinition/eflow-rx-eu-is-redeemable-by-properties-extension)
