# GEM ERP EX AcceptDate - E-Rezept für Arzneimittel v1.0.0-test
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/erp/StructureDefinition/GEM-ERP-EX-AcceptDate | *Version*:1.0.0-test |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/de.gematik.tiflow-rx|current/StructureDefinition/GEM-ERP-EX-AcceptDate)
