# Quittungs-Bundle für abgeschlossene Rezeptabgabe - E-Rezept für Arzneimittel v1.0.0-test
...
```json
{
  ...
  "meta" : {
    "profile" : ["https://gematik.de/fhir/erp/StructureDefinition/GEM-ERP-PR-Bundle"],
    "tag" : [{
  ...
  "entry" : [{
    ...
    "resource" : {
      ...
      "type" : {
        "coding" : [{
          "system" : "https://gematik.de/fhir/erp/CodeSystem/GEM-ERP-CS-DocumentType",
          "code" : "3",
          "display" : "Receipt"
        }]
      },
