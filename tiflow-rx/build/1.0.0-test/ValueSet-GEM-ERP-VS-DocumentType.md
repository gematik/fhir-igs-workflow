# ValueSet der Dokumenttyp-Codes - E-Rezept für Arzneimittel v1.0.0-test
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/erp/ValueSet/GEM-ERP-VS-DocumentType | *Version*:1.0.0-test |
...
```json
{
  ...
  "url" : "https://gematik.de/fhir/erp/ValueSet/GEM-ERP-VS-DocumentType",
  "version" : "1.0.0-test",
