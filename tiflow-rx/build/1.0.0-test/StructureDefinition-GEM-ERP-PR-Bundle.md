# GEM ERP PR Bundle - E-Rezept für Arzneimittel v1.0.0-test
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/erp/StructureDefinition/GEM-ERP-PR-Bundle | *Version*:1.0.0-test |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/de.gematik.tiflow-rx|current/StructureDefinition/GEM-ERP-PR-Bundle)
...
```json
{
  ...
  "url" : "https://gematik.de/fhir/erp/StructureDefinition/GEM-ERP-PR-Bundle",
  "version" : "1.0.0-test",
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Composition",
        "profile" : ["https://gematik.de/fhir/erp/StructureDefinition/GEM-ERP-PR-Composition"]
      }]
    },
    {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Binary",
        "profile" : ["https://gematik.de/fhir/erp/StructureDefinition/GEM-ERP-PR-Digest"]
      }]
    },
    {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Signature",
        "profile" : ["https://gematik.de/fhir/erp/StructureDefinition/GEM-ERP-PR-Signature"]
      }],
      "mustSupport" : true
    }]
  }
