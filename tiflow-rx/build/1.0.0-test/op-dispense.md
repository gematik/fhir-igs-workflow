# Operation $dispense (Dispensierinformationen bereitstellen) - E-Rezept für Arzneimittel v1.0.0-test
...
* [Ergänzende Server-Anforderungen zu `$dispense`](./op-dispense-fd-requirements.md): Anforderungen an den E-Rezept-Fachdienst zur Bereitstellung der Schnittstelle.
* [Ergänzende Client-Anforderungen zu `$dispense`](./op-dispense-client-requirements.md): Anforderungen an den Client des E-Rezept-Fachdienstes zur Nutzung der Schnittstelle.
