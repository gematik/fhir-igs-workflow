# GEM ERP VS OperationOutcomeDetails - E-Rezept für Arzneimittel v1.0.0-test
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/erp/ValueSet/GEM-ERP-VS-OperationOutcomeDetails | *Version*:1.0.0-test |
| Draft as of 2025-12-15 | *Computable Name*:GEM_ERP_VS_OperationOutcomeDetails |
...
```json
{
  ...
  "url" : "https://gematik.de/fhir/erp/ValueSet/GEM-ERP-VS-OperationOutcomeDetails",
  "version" : "1.0.0-test",
  ...
  "compose" : {
    "include" : [{
      "system" : "https://gematik.de/fhir/erp/CodeSystem/GEM-ERP-CS-OperationOutcomeDetails"
    },
    {
