# AVS-Anforderungen $close - Implementation Guide TIFlow - Verordnungen für Arzneimittel v2.0.0-ballot.2
...
funkt. Eignung: HerstellererklärungDas PS der abgebenden LEI MUSS den Anwendungsfall "Quittung abrufen" für Verordnungen, welche abschließend verarbeitet wurden, ausführen, um den Workflow am TI-Flow-Fachdienst abzuschließen.
Die Erstellung der MedicationDispense erfolgt Flowtype-spezifisch.

funkt. Eignung: HerstellererklärungDas PS der abgebenden LEI MUSS im Anwendungsfall "Quittung abrufen" für das abgegebene E-Rezept die HTTP-Operation POST /Task/<id>/$close mit
* Task-ID in URL <id>
...
funkt. Eignung: HerstellererklärungDas PS der abgebenden LEI KANN im Anwendungsfall "Quittung abrufen" zum Prüfen der Quittung des E-Rezepts die Operation POST //Konnektorservice mit
...
funkt. Eignung: HerstellererklärungDas PS der abgebenden LEI KANN im Anwendungsfall "Quittung abrufen" mehrere Vorgänge im Stapel verarbeiten.
