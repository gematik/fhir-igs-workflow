# GEM ERP CS OperationOutcomeDetails - TIFlow - Verordnungen für Arzneimittel v0.9.0
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/tiflow/erezept/CodeSystem/GEM-ERP-CS-OperationOutcomeDetails | *Version*:0.9.0 |
...
```json
{
  ...
  "url" : "https://gematik.de/fhir/tiflow/erezept/CodeSystem/GEM-ERP-CS-OperationOutcomeDetails",
  "version" : "0.9.0",
