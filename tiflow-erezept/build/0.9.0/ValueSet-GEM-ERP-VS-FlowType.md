# ValueSet der FlowType-Codes - TIFlow - Verordnungen für Arzneimittel v0.9.0
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/tiflow/erezept/ValueSet/GEM-ERP-VS-FlowType | *Version*:0.9.0 |
...
```json
{
  ...
  "url" : "https://gematik.de/fhir/tiflow/erezept/ValueSet/GEM-ERP-VS-FlowType",
  "version" : "0.9.0",
