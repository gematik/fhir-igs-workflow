# GEM ERP PR DispenseOperation Input - TIFlow - Verordnungen für Arzneimittel v0.9.0
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/tiflow/erezept/StructureDefinition/eflow-rx-dispense-operation-input-parameters | *Version*:0.9.0 |
| Draft as of 2025-12-15 | *Computable Name*:EFlowRxDispenseOperationInputParameters |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/de.gematik.tiflow.erezept|current/StructureDefinition/eflow-rx-dispense-operation-input-parameters)
...
Other representations of profile: [CSV](StructureDefinition-eflow-rx-dispense-operation-input-parameters.csv), [Excel](StructureDefinition-eflow-rx-dispense-operation-input-parameters.xlsx), [Schematron](StructureDefinition-eflow-rx-dispense-operation-input-parameters.sch) 
...
```json
{
  ...
  "id" : "eflow-rx-dispense-operation-input-parameters",
  "url" : "https://gematik.de/fhir/tiflow/erezept/StructureDefinition/eflow-rx-dispense-operation-input-parameters",
  "version" : "0.9.0",
  "name" : "EFlowRxDispenseOperationInputParameters",
  ...
  "differential" : {
    ...
    },
    {
      ...
      "constraint" : [{
        ...
        "source" : "https://gematik.de/fhir/tiflow/erezept/StructureDefinition/eflow-rx-dispense-operation-input-parameters"
      }]
    },
    {
