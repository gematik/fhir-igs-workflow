# Example Dispense Parameters - TIFlow - Verordnungen für Arzneimittel v0.9.0
...
```json
{
  ...
  "meta" : {
    "profile" : ["https://gematik.de/fhir/tiflow/erezept/StructureDefinition/eflow-rx-dispense-operation-input-parameters"]
  },
  "parameter" : [{
    "name" : "rxDispensation",
    "part" : [{
