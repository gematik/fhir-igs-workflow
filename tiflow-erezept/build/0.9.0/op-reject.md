# Operation $reject (Task zurückweisen) - TIFlow - Verordnungen für Arzneimittel v0.9.0
...
* [Ergänzende Server-Anforderungen zu `$reject`](./op-reject-req-fd.md): Anforderungen an den E-Rezept-Fachdienst zur Bereitstellung der Schnittstelle.
