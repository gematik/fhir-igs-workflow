# GEM ERP PR CloseOperation Output - TIFlow - Verordnungen für Arzneimittel v0.9.0
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/tiflow/erezept/StructureDefinition/eflow-rx-close-operation-output-parameters | *Version*:0.9.0 |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/de.gematik.tiflow.erezept|current/StructureDefinition/eflow-rx-close-operation-output-parameters)
...
```json
{
  ...
  "url" : "https://gematik.de/fhir/tiflow/erezept/StructureDefinition/eflow-rx-close-operation-output-parameters",
  "version" : "0.9.0",
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Bundle",
        "profile" : ["https://gematik.de/fhir/tiflow/erezept/StructureDefinition/GEM-ERP-PR-Bundle"]
      }]
    },
    {
