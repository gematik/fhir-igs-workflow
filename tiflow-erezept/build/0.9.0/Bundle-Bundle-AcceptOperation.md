# Beispiel Accept-Bundle - TIFlow - Verordnungen für Arzneimittel v0.9.0
...
* **Beispiel Accept-Bundle**

## Example Bundle: Beispiel Accept-Bundle
...
```json
{
  ...
  "meta" : {
    "profile" : ["https://gematik.de/fhir/tiflow/erezept/StructureDefinition/GEM-ERP-PR-Bundle-OP-Accept"]
  },
  "type" : "collection",
  "link" : [{
    "relation" : "self",
  ...
  },
  {
    ...
    "resource" : {
      ...
      "meta" : {
        "profile" : ["https://gematik.de/fhir/tiflow/erezept/StructureDefinition/GEM-ERP-PR-Binary"]
      },
