# Zuweisung des Patienten an die Apotheke - TIFlow - Verordnungen für Arzneimittel v0.9.0
...
```json
{
  ...
  "meta" : {
    "profile" : ["https://gematik.de/fhir/tiflow/erezept/StructureDefinition/GEM-ERP-PR-Communication-DispReq"],
    "tag" : [{
