...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <!-- 
    This file contains just the constraints for the profile GEM_ERP_PR_Communication
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Communication/f:payload">
      <sch:assert test="count(f:extension[@url = 'https://gematik.de/fhir/tiflow/erezept/StructureDefinition/GEM-ERP-EX-SupplyOptionsType']) &lt;= 1">extension with URL = 'https://gematik.de/fhir/tiflow/erezept/StructureDefinition/GEM-ERP-EX-SupplyOptionsType': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://gematik.de/fhir/tiflow/erezept/StructureDefinition/GEM-ERP-EX-AvailabilityState']) &lt;= 1">extension with URL = 'https://gematik.de/fhir/tiflow/erezept/StructureDefinition/GEM-ERP-EX-AvailabilityState': maximum cardinality of 'extension' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
</sch:schema>
