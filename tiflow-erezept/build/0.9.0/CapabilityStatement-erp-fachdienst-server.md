# ERP CapabilityStatement für den E-Rezept-Fachdienst - TIFlow - Verordnungen für Arzneimittel v0.9.0
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/tiflow/erezept/CapabilityStatement/erp-fachdienst-server | *Version*:0.9.0 |
...
```json
{
  ...
  "url" : "https://gematik.de/fhir/tiflow/erezept/CapabilityStatement/erp-fachdienst-server",
  "version" : "0.9.0",
