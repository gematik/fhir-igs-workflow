# GEM ERP PR Communication Reply - TIFlow - Verordnungen für Arzneimittel v0.9.0
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/tiflow/erezept/StructureDefinition/GEM-ERP-PR-Communication-Reply | *Version*:0.9.0 |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/de.gematik.tiflow.erezept|current/StructureDefinition/GEM-ERP-PR-Communication-Reply)
...
```json
{
  ...
  "url" : "https://gematik.de/fhir/tiflow/erezept/StructureDefinition/GEM-ERP-PR-Communication-Reply",
  "version" : "0.9.0",
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://gematik.de/fhir/tiflow/erezept/StructureDefinition/GEM-ERP-EX-SupplyOptionsType"]
      }]
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://gematik.de/fhir/tiflow/erezept/StructureDefinition/GEM-ERP-EX-AvailabilityState"]
      }]
    },
    {
