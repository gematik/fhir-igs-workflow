# ERP Capability Statement für Clients des E-Rezept-Fachdienst - TIFlow - Verordnungen für Arzneimittel v0.9.0
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/tiflow/erezept/CapabilityStatement/erp-fachdienst-client | *Version*:0.9.0 |
...
```json
{
  ...
  "url" : "https://gematik.de/fhir/tiflow/erezept/CapabilityStatement/erp-fachdienst-client",
  "version" : "0.9.0",
  ...
  "rest" : [{
    ...
    "resource" : [{
      ...
      "supportedProfile" : ["https://gematik.de/fhir/tiflow/erezept/StructureDefinition/GEM-ERP-PR-MedicationDispense"],
      "_supportedProfile" : [{
        "extension" : [{
          "url" : "http://hl7.org/fhir/StructureDefinition/capabilitystatement-expectation",
          "valueCode" : "SHALL"
    ...
    },
    {
      ...
      "operation" : [{
        ...
        "definition" : "https://gematik.de/fhir/tiflow/erezept/OperationDefinition/CreateOperation"
      },
      {
        "extension" : [{
          "url" : "http://hl7.org/fhir/StructureDefinition/capabilitystatement-expectation",
        ...
        "definition" : "https://gematik.de/fhir/tiflow/erezept/OperationDefinition/ActivateOperation"
      },
      {
        "extension" : [{
          "url" : "http://hl7.org/fhir/StructureDefinition/capabilitystatement-expectation",
        ...
        "name" : "abortOperation",
        "definition" : "https://gematik.de/fhir/tiflow/erezept/OperationDefinition/AbortOperation"
      }]
    }]
  }]
}
