# Beispiel Erfolgsantwort der Rx $accept Operation - Implementation Guide TIFlow - Verordnungen für Arzneimittel v2.0.0-ballot.2
...
* **Beispiel Erfolgsantwort der Rx $accept Operation**

## Example Parameters: Beispiel Erfolgsantwort der Rx $accept Operation
...
```json
{
  ...
  "meta" : {
    "profile" : ["https://gematik.de/fhir/tiflow-erezept/StructureDefinition/GEM-ERP-PR-PAR-Accept-Operation-Output"]
  },
  "parameter" : [{
    "name" : "return",
    "resource" : {
      ...
      "meta" : {
        "profile" : ["https://gematik.de/fhir/erp/StructureDefinition/GEM_ERP_PR_Bundle_OP_Accept|2.0"]
      },
      "type" : "collection",
      "link" : [{
        "relation" : "self",
