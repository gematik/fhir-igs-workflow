...
```json
{
  ...
  "definition" : {
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "Bundle/ExampleRxCommunicationSearchsetResponse"
      },
      "name" : "Antwortbundle für GET /Communication (Rx)",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "Bundle/ExampleRxMedicationDispenseSearchsetResponse"
      },
      "name" : "Antwortbundle für GET /MedicationDispense (Rx)",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "Bundle/ExampleRxTaskSearchsetResponse"
      },
      "name" : "Antwortbundle für GET /Task (Rx)",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "Bundle/ExampleRxTaskSearchsetResponseReady"
      },
      "name" : "Antwortbundle für GET /Task?status=ready (Rx)",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "Parameters/ExampleRxAcceptOutputParameters"
      },
      "name" : "Beispiel Erfolgsantwort der Rx $accept Operation",
      ...
      "exampleCanonical" : "https://gematik.de/fhir/tiflow-erezept/StructureDefinition/GEM-ERP-PR-PAR-Accept-Operation-Output"
    },
    {
      "extension" : [{
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/resource-information",
      ...
      "reference" : {
        "reference" : "Parameters/ExampleRxCloseOutputParameters"
      },
      "name" : "Beispiel Erfolgsantwort der Rx $close Operation",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "OperationOutcome/ExampleRxAbortOperationOutcomeError"
      },
      "name" : "Beispiel Operation Outcome für Rx $abort Operation",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "OperationOutcome/ExampleRxAcceptOperationOutcomeError"
      },
      "name" : "Beispiel Operation Outcome für Rx $accept Operation",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "OperationOutcome/ExampleRxActivateOperationOutcomeError"
      },
      "name" : "Beispiel Operation Outcome für Rx $activate Operation",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "OperationOutcome/ExampleRxCloseOperationOutcomeError"
      },
      "name" : "Beispiel Operation Outcome für Rx $close Operation",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "OperationOutcome/ExampleRxCreateOperationOutcomeError"
      },
      "name" : "Beispiel Operation Outcome für Rx $create Operation",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "OperationOutcome/ExampleRxDispenseOperationOutcomeError"
      },
      "name" : "Beispiel Operation Outcome für Rx $dispense Operation",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "OperationOutcome/ExampleRxRejectOperationOutcomeError"
      },
      "name" : "Beispiel Operation Outcome für Rx $reject Operation",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "Parameters/ExampleRxActivateOperationRequestParameters"
      },
      "name" : "Example request parameters for Rx $activate operation",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "Parameters/ExampleRxCreateOperationRequestParameters"
      },
      "name" : "Example request parameters for Rx $create operation",
