# Beispiel Medikamentenabgabe mit Dosierung nach Uhrzeitbezug - Implementation Guide TIFlow - Verordnungen für Arzneimittel v2.0.0-ballot.2
...
* **Beispiel Medikamentenabgabe mit Dosierung nach Uhrzeitbezug**

## Example MedicationDispense: Beispiel Medikamentenabgabe mit Dosierung nach Uhrzeitbezug
...
```json
{
  ...
  "id" : "Example-MedicationDispense-Dosage-uhrzeit",
  "meta" : {
