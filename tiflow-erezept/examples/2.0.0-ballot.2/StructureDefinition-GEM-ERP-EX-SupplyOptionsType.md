# GEM ERP EX SupplyOptionsType - Implementation Guide TIFlow - Verordnungen für Arzneimittel v2.0.0-ballot.2
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/erp/StructureDefinition/GEM_ERP_EX_SupplyOptionsType | *Version*:2.0.0-ballot.2 |
| Active as of 2028-04-01 | *Computable Name*:GEM_ERP_EX_SupplyOptionsType |
...
* Examples for this Extension: [Bundle/ExampleRxCommunicationSearchsetResponse](Bundle-ExampleRxCommunicationSearchsetResponse.md) and [Communication/7977a4ab-97a9-4d95-afb3-6c4c1e2ac596](Communication-7977a4ab-97a9-4d95-afb3-6c4c1e2ac596.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/de.gematik.tiflow.erezept|current/StructureDefinition/StructureDefinition-GEM-ERP-EX-SupplyOptionsType.json)
...
Other representations of profile: [CSV](StructureDefinition-GEM-ERP-EX-SupplyOptionsType.csv), [Excel](StructureDefinition-GEM-ERP-EX-SupplyOptionsType.xlsx), [Schematron](StructureDefinition-GEM-ERP-EX-SupplyOptionsType.sch) 
