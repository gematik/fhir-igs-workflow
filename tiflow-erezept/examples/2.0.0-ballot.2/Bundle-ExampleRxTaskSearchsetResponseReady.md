# Antwortbundle für GET /Task?status=ready (Rx) - Implementation Guide TIFlow - Verordnungen für Arzneimittel v2.0.0-ballot.2
...
* **Antwortbundle für GET /Task?status=ready (Rx)**

## Example Bundle: Antwortbundle für GET /Task?status=ready (Rx)
...
```json
{
  ...
  "link" : [{
    "relation" : "self",
    "url" : "https://erp-ref.zentral.erp.splitdns.ti-dienste.de/Task?status=ready"
  }],
  "entry" : [{
