# GEM ERP EX EU IS REDEEMABLE BY PATIENT AUTHORIZATION - TIFlow - Verordnungen für Arzneimittel v0.9.0
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/tiflow/erezept/StructureDefinition/eflow-rx-eu-is-redeemable-by-patient-authorization-extension | *Version*:0.9.0 |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/de.gematik.tiflow.erezept|current/StructureDefinition/eflow-rx-eu-is-redeemable-by-patient-authorization-extension)
...
```json
{
  ...
  "url" : "https://gematik.de/fhir/tiflow/erezept/StructureDefinition/eflow-rx-eu-is-redeemable-by-patient-authorization-extension",
  "version" : "0.9.0",
  ...
  "differential" : {
    ...
    },
    {
      "id" : "Extension.url",
      "path" : "Extension.url",
      "fixedUri" : "https://gematik.de/fhir/tiflow/erezept/StructureDefinition/eflow-rx-eu-is-redeemable-by-patient-authorization-extension"
    },
    {
