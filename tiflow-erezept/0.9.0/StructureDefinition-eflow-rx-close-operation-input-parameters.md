# GEM ERP PR CloseOperation Input - TIFlow - Verordnungen für Arzneimittel v0.9.0
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/tiflow/erezept/StructureDefinition/eflow-rx-close-operation-input-parameters | *Version*:0.9.0 |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/de.gematik.tiflow.erezept|current/StructureDefinition/eflow-rx-close-operation-input-parameters)
...
```json
{
  ...
  "url" : "https://gematik.de/fhir/tiflow/erezept/StructureDefinition/eflow-rx-close-operation-input-parameters",
  "version" : "0.9.0",
  ...
  "differential" : {
    ...
    },
    {
      ...
      "constraint" : [{
        ...
        "source" : "https://gematik.de/fhir/tiflow/erezept/StructureDefinition/eflow-rx-close-operation-input-parameters"
      },
      {
