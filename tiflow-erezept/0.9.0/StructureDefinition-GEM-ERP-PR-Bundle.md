# GEM ERP PR Bundle - TIFlow - Verordnungen für Arzneimittel v0.9.0
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/tiflow/erezept/StructureDefinition/GEM-ERP-PR-Bundle | *Version*:0.9.0 |
| Draft as of 2025-12-15 | *Computable Name*:GEM_ERP_PR_Bundle |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/de.gematik.tiflow.erezept|current/StructureDefinition/GEM-ERP-PR-Bundle)
...
```json
{
  ...
  "url" : "https://gematik.de/fhir/tiflow/erezept/StructureDefinition/GEM-ERP-PR-Bundle",
  "version" : "0.9.0",
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Composition",
        "profile" : ["https://gematik.de/fhir/tiflow/erezept/StructureDefinition/GEM-ERP-PR-Composition"]
      }]
    },
    {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Binary",
        "profile" : ["https://gematik.de/fhir/tiflow/erezept/StructureDefinition/GEM-ERP-PR-Digest"]
      }]
    },
    {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Signature",
        "profile" : ["https://gematik.de/fhir/tiflow/erezept/StructureDefinition/GEM-ERP-PR-Signature"]
      }],
      "mustSupport" : true
    }]
  }
