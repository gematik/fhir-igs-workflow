# Quittungs-Bundle für abgeschlossene Rezeptabgabe - TIFlow - Verordnungen für Arzneimittel v0.9.0
...
```json
{
  ...
  "entry" : [{
    ...
    "resource" : {
      ...
      "type" : {
        "coding" : [{
          "system" : "https://gematik.de/fhir/tiflow/erezept/CodeSystem/GEM-ERP-CS-DocumentType",
          "code" : "3",
          "display" : "Receipt"
        }]
      },
