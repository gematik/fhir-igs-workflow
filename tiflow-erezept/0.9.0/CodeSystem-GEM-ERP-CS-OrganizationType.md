# CodeSystem der Organisationstyp-Codes - TIFlow - Verordnungen für Arzneimittel v0.9.0
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/tiflow/erezept/CodeSystem/GEM-ERP-CS-OrganizationType | *Version*:0.9.0 |
| Draft as of 2025-12-15 | *Computable Name*:GEM_ERP_CS_OrganizationType |
...
```json
{
  ...
  "url" : "https://gematik.de/fhir/tiflow/erezept/CodeSystem/GEM-ERP-CS-OrganizationType",
  "version" : "0.9.0",
