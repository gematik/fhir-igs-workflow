# CloseOperation - TIFlow - Verordnungen für Arzneimittel v0.9.0
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/tiflow/erezept/OperationDefinition/CloseOperation | *Version*:0.9.0 |
...
```json
{
  ...
  "id" : "CloseOperation",
  "url" : "https://gematik.de/fhir/tiflow/erezept/OperationDefinition/CloseOperation",
  "version" : "0.9.0",
  "name" : "Close",
  "status" : "draft",
  "kind" : "operation",
  ...
  "type" : false,
  "instance" : true,
  "inputProfile" : "https://gematik.de/fhir/tiflow/erezept/StructureDefinition/eflow-rx-close-operation-input-parameters",
  "outputProfile" : "https://gematik.de/fhir/tiflow/erezept/StructureDefinition/eflow-rx-close-operation-output-parameters",
  "parameter" : [{
    "name" : "secret",
    "use" : "in",
    "min" : 1,
