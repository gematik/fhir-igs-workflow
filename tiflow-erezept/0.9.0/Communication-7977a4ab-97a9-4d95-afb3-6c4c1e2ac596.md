# Antwort-Nachricht der Apotheke an den Patienten - TIFlow - Verordnungen für Arzneimittel v0.9.0
...
```json
{
  ...
  "meta" : {
    "profile" : ["https://gematik.de/fhir/tiflow/erezept/StructureDefinition/GEM-ERP-PR-Communication-Reply"],
    "tag" : [{
  ...
  "payload" : [{
    "extension" : [{
      ...
      "valueCoding" : {
        "system" : "https://gematik.de/fhir/tiflow/erezept/CodeSystem/GEM-ERP-CS-AvailabilityStatus",
        "code" : "20"
      }
    },
    {
