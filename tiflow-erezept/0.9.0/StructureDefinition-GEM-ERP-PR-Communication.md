# GEM ERP PR Communication - TIFlow - Verordnungen für Arzneimittel v0.9.0
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/tiflow/erezept/StructureDefinition/GEM-ERP-PR-Communication | *Version*:0.9.0 |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/de.gematik.tiflow.erezept|current/StructureDefinition/GEM-ERP-PR-Communication)
...
```json
{
  ...
  "url" : "https://gematik.de/fhir/tiflow/erezept/StructureDefinition/GEM-ERP-PR-Communication",
  "version" : "0.9.0",
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Reference",
        "targetProfile" : ["https://gematik.de/fhir/tiflow/erezept/StructureDefinition/GEM-ERP-PR-Task"],
