# DispenseOperation - TIFlow - Verordnungen für Arzneimittel v0.9.0
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/tiflow/erezept/OperationDefinition/DispenseOperation | *Version*:0.9.0 |
...
```json
{
  ...
  "url" : "https://gematik.de/fhir/tiflow/erezept/OperationDefinition/DispenseOperation",
  "version" : "0.9.0",
  "name" : "Dispense",
  "status" : "draft",
  "kind" : "operation",
  ...
  "type" : false,
  "instance" : true,
  "inputProfile" : "https://gematik.de/fhir/tiflow/erezept/StructureDefinition/eflow-rx-dispense-operation-input-parameters",
  "parameter" : [{
    "name" : "secret",
    "use" : "in",
    "min" : 1,
