# GEM ERP PR Task - TIFlow - Verordnungen für Arzneimittel v0.9.0
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/tiflow/erezept/StructureDefinition/GEM-ERP-PR-Task | *Version*:0.9.0 |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/de.gematik.tiflow.erezept|current/StructureDefinition/GEM-ERP-PR-Task)
...
```json
{
  ...
  "id" : "GEM-ERP-PR-Task",
  "url" : "https://gematik.de/fhir/tiflow/erezept/StructureDefinition/GEM-ERP-PR-Task",
  "version" : "0.9.0",
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://gematik.de/fhir/tiflow/erezept/StructureDefinition/GEM-ERP-EX-PrescriptionType"]
      }],
      "mustSupport" : true
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://gematik.de/fhir/tiflow/erezept/StructureDefinition/GEM-ERP-EX-AcceptDate"]
      }],
      "mustSupport" : true
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://gematik.de/fhir/tiflow/erezept/StructureDefinition/GEM-ERP-EX-ExpiryDate"]
      }],
      "mustSupport" : true
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://gematik.de/fhir/tiflow/erezept/StructureDefinition/GEM-ERP-EX-LastMedicationDispense"]
      }]
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://gematik.de/fhir/tiflow/erezept/StructureDefinition/eflow-rx-eu-is-redeemable-by-properties-extension"]
      }],
      "mustSupport" : true
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://gematik.de/fhir/tiflow/erezept/StructureDefinition/eflow-rx-eu-is-redeemable-by-patient-authorization-extension"]
      }],
      "mustSupport" : true
    },
    {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Identifier",
        "profile" : ["https://gematik.de/fhir/tiflow/erezept/StructureDefinition/GEM-ERP-PR-Secret"]
      }]
    },
    {
      "id" : "Task.intent",
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "required",
        "valueSet" : "https://gematik.de/fhir/tiflow/erezept/ValueSet/GEM-ERP-VS-OrganizationType"
      }
    },
    {
      "id" : "Task.input",
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "required",
        "valueSet" : "https://gematik.de/fhir/tiflow/erezept/ValueSet/GEM-ERP-VS-DocumentType"
      }
    },
    {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Reference",
        "targetProfile" : ["https://gematik.de/fhir/tiflow/erezept/StructureDefinition/GEM-ERP-PR-Binary"]
      }]
    },
    {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Reference",
        "targetProfile" : ["https://gematik.de/fhir/tiflow/erezept/StructureDefinition/GEM-ERP-PR-Bundle"]
      }]
    }]
  }
}
