# GEM ERP PR Composition - TIFlow - Verordnungen für Arzneimittel v0.9.0
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/tiflow/erezept/StructureDefinition/GEM-ERP-PR-Composition | *Version*:0.9.0 |
| Draft as of 2025-12-15 | *Computable Name*:GEM_ERP_PR_Composition |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/de.gematik.tiflow.erezept|current/StructureDefinition/GEM-ERP-PR-Composition)
...
Other representations of profile: [CSV](StructureDefinition-GEM-ERP-PR-Composition.csv), [Excel](StructureDefinition-GEM-ERP-PR-Composition.xlsx), [Schematron](StructureDefinition-GEM-ERP-PR-Composition.sch) 
...
```json
{
  ...
  "url" : "https://gematik.de/fhir/tiflow/erezept/StructureDefinition/GEM-ERP-PR-Composition",
  "version" : "0.9.0",
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://gematik.de/fhir/tiflow/erezept/StructureDefinition/GEM-ERP-EX-Beneficiary"]
      }]
    },
    {
    ...
    },
    {
      ...
      "min" : 1,
      "fixedUri" : "https://gematik.de/fhir/tiflow/erezept/CodeSystem/GEM-ERP-CS-DocumentType"
    },
    {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Reference",
        "targetProfile" : ["https://gematik.de/fhir/tiflow/erezept/StructureDefinition/GEM-ERP-PR-Device"],
