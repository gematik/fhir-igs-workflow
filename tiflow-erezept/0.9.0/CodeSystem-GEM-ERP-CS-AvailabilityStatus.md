# CodeSystem des Verfügbarkeitsstatus - TIFlow - Verordnungen für Arzneimittel v0.9.0
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/tiflow/erezept/CodeSystem/GEM-ERP-CS-AvailabilityStatus | *Version*:0.9.0 |
...
```json
{
  ...
  "url" : "https://gematik.de/fhir/tiflow/erezept/CodeSystem/GEM-ERP-CS-AvailabilityStatus",
  "version" : "0.9.0",
