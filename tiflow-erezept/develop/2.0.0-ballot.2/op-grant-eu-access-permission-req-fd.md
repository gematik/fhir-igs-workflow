# Server Anforderungen: Zugriffsberechtigung erstellen - Implementation Guide TIFlow - Verordnungen für Arzneimittel v2.0.0-ballot.2
...
* HTTP-Code: Details Code
  * 409 - Conflict: TIFLOW_EREZEPT_COUNTRY_CODE_INVALID
* HTTP-Code: Details Text
