# Example EU-Close Parameters - Implementation Guide TIFlow - Verordnungen für Arzneimittel v2.0.0-ballot.2
...
```json
{
  ...
  "meta" : {
    "profile" : ["https://gematik.de/fhir/tiflow-erezept/StructureDefinition/GEM-ERPEU-PR-PAR-Close-Operation-Input"]
  },
  "parameter" : [{
    "name" : "rxDispensation",
    "part" : [{
