...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <!-- 
    This file contains just the constraints for the profile TIFlowCommunication
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Communication">
      ...
      <sch:assert test="count(f:about) &lt;= 0">about: maximum cardinality of 'about' is 0</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:Communication/f:basedOn</sch:title>
