# ReadEUAccessPermission - Implementation Guide TIFlow - Verordnungen für Arzneimittel v2.0.0-ballot.2
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/tiflow-erezept/OperationDefinition/ReadEUAccessPermission | *Version*:2.0.0-ballot.2 |
...
```json
{
  ...
  "url" : "https://gematik.de/fhir/tiflow-erezept/OperationDefinition/ReadEUAccessPermission",
