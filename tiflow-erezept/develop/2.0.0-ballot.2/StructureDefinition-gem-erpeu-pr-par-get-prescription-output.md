# GEM ERPEU PR PAR GET Prescription Output - Implementation Guide TIFlow - Verordnungen für Arzneimittel v2.0.0-ballot.2
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/tiflow-erezept/StructureDefinition/gem-erpeu-pr-par-get-prescription-output | *Version*:2.0.0-ballot.2 |
| Draft as of 2026-06-30 | *Computable Name*:GEM_ERPEU_PR_PAR_GET_Prescription_Output |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/de.gematik.tiflow.erezept|current/StructureDefinition/StructureDefinition-gem-erpeu-pr-par-get-prescription-output.json)
...
```json
{
  ...
  "url" : "https://gematik.de/fhir/tiflow-erezept/StructureDefinition/gem-erpeu-pr-par-get-prescription-output",
