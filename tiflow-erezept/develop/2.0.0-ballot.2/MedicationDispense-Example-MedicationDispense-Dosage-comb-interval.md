# Beispiel Medikamentenabgabe mit Dosierung nach Kombination des Intervals - Implementation Guide TIFlow - Verordnungen für Arzneimittel v2.0.0-ballot.2
...
* **Beispiel Medikamentenabgabe mit Dosierung nach Kombination des Intervals**

## Example MedicationDispense: Beispiel Medikamentenabgabe mit Dosierung nach Kombination des Intervals
...
```json
{
  ...
  "id" : "Example-MedicationDispense-Dosage-comb-interval",
  "meta" : {
