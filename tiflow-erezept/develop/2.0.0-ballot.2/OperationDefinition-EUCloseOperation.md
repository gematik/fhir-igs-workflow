# EUCloseOperation - Implementation Guide TIFlow - Verordnungen für Arzneimittel v2.0.0-ballot.2
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/tiflow-erezept/OperationDefinition/EUCloseOperation | *Version*:2.0.0-ballot.2 |
...
```json
{
  ...
  "id" : "EUCloseOperation",
  "url" : "https://gematik.de/fhir/tiflow-erezept/OperationDefinition/EUCloseOperation",
  ...
  "type" : false,
  "instance" : true,
  "inputProfile" : "https://gematik.de/fhir/tiflow-erezept/StructureDefinition/GEM-ERPEU-PR-PAR-Close-Operation-Input"
}
