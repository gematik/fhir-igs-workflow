# GEM ERP PR Medication - Implementation Guide TIFlow - Verordnungen für Arzneimittel v2.0.0-ballot.3
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/erp/StructureDefinition/GEM_ERP_PR_Medication | *Version*:2.0.0-ballot.3 |
| Active as of 2026-06-30 | *Computable Name*:GEM_ERP_PR_Medication |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/de.gematik.tiflow.erezept|current/StructureDefinition/StructureDefinition-GEM-ERP-PR-Medication.json)
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "min" : 1,
      "max" : "1",
      "fixedCanonical" : "https://gematik.de/fhir/erp/StructureDefinition/GEM_ERP_PR_Medication|2.0",
      "mustSupport" : true
    },
    {
