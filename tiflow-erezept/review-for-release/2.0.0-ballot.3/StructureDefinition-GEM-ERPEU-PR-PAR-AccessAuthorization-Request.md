# GEM ERPEU PR PAR Access Authorization Request - Implementation Guide TIFlow - Verordnungen für Arzneimittel v2.0.0-ballot.3
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/tiflow-erezept/StructureDefinition/GEM-ERPEU-PR-PAR-AccessAuthorization-Request | *Version*:2.0.0-ballot.3 |
| Draft as of 2026-06-30 | *Computable Name*:GEM_ERPEU_PR_PAR_Access_Authorization_Request |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/de.gematik.tiflow.erezept|current/StructureDefinition/StructureDefinition-GEM-ERPEU-PR-PAR-AccessAuthorization-Request.json)
...
```json
{
  ...
  "url" : "https://gematik.de/fhir/tiflow-erezept/StructureDefinition/GEM-ERPEU-PR-PAR-AccessAuthorization-Request",
