# Mapping der Verschreibung für Verordnungsdaten - Implementation Guide TIFlow - Verordnungen für Arzneimittel v2.0.0-ballot.3
...
* zur [EPA MedicationRequest](https://gemspec.gematik.de/ig/fhir/epa-medication/1.3.5/StructureDefinition-epa-medication-request.html).
