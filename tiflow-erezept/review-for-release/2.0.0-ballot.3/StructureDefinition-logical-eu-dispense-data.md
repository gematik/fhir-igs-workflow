# Dispense Data from EU - Implementation Guide TIFlow - Verordnungen für Arzneimittel v2.0.0-ballot.3
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/tiflow-erezept/StructureDefinition/logical-eu-dispense-data | *Version*:2.0.0-ballot.3 |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/de.gematik.tiflow.erezept|current/StructureDefinition/StructureDefinition-logical-eu-dispense-data.json)
...
```json
{
  ...
  "url" : "https://gematik.de/fhir/tiflow-erezept/StructureDefinition/logical-eu-dispense-data",
  ...
  "kind" : "logical",
  "abstract" : false,
  "type" : "https://gematik.de/fhir/tiflow-erezept/StructureDefinition/logical-eu-dispense-data",
