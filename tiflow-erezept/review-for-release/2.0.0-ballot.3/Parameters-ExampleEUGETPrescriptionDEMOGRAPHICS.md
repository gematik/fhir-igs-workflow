# Example EU-GET Prescription Parameters - Implementation Guide TIFlow - Verordnungen für Arzneimittel v2.0.0-ballot.3
...
```json
{
  ...
  "meta" : {
    "profile" : ["https://gematik.de/fhir/tiflow-erezept/StructureDefinition/GEM-ERPEU-PR-PAR-EU-GET-Prescription-Input"]
  },
  "parameter" : [{
    "name" : "requestData",
    "part" : [{
