# Beispiel Medikamentenabgabe mit Dosierung nach 4er Schema - Implementation Guide TIFlow - Verordnungen für Arzneimittel v2.0.0-ballot.3
...
* **Beispiel Medikamentenabgabe mit Dosierung nach 4er Schema**

## Example MedicationDispense: Beispiel Medikamentenabgabe mit Dosierung nach 4er Schema
...
```json
{
  ...
  "id" : "Example-MedicationDispense-Dosage-tageszeit",
  "meta" : {
