# $accept response for RX - Implementation Guide TIFlow - Verordnungen für Arzneimittel v2.0.0-ballot.3
...
* **$accept response for RX**

## Example Bundle: $accept response for RX
...
```json
{
  ...
  {
    "fullUrl" : "https://erp-ref.example.org/Binary/PrescriptionBinaryWithMeta",
    "resource" : {
      "resourceType" : "Binary",
