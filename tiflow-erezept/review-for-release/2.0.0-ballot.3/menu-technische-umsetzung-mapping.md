# Vorgaben zum Mapping von FHIR-Instanzen - Implementation Guide TIFlow - Verordnungen für Arzneimittel v2.0.0-ballot.3
...
Die Verordnungsdaten werden vom TI-Flow-Fachdienst an den ePA Medication Service via ([ePA Operation API: Verordnung einstellen](https://gemspec.gematik.de/ig/fhir/epa-medication/1.3.5/op-provide-prescription-erp.html)).
