# ValueSet of Consent PolyRule Codes - Implementation Guide TIFlow - Verordnungen für Arzneimittel v2.0.0-ballot.3
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/tiflow-erezept/ValueSet/GEM-ERPEU-VS-Consent-PolicyRule | *Version*:2.0.0-ballot.3 |
| Draft as of 2026-06-30 | *Computable Name*:GEM_ERPEU_VS_Consent_PolicyRule |
...
```json
{
  ...
  "url" : "https://gematik.de/fhir/tiflow-erezept/ValueSet/GEM-ERPEU-VS-Consent-PolicyRule",
