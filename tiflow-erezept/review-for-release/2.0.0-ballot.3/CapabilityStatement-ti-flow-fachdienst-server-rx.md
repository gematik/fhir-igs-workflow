# TIFlow Fachdienst Server Capabilities - Implementation Guide TIFlow - Verordnungen für Arzneimittel v2.0.0-ballot.3
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/tiflow-erezept/CapabilityStatement/ti-flow-fachdienst-server-rx | *Version*:2.0.0-ballot.3 |
  ...
  "rest" : [{
    ...
    "operation" : [{
      ...
      },
      {
        ...
        {
          "url" : "errorCode",
          "valueString" : "TIFLOW_EREZEPT_COUNTRY_CODE_INVALID"
        }],
        "url" : "https://gematik.de/fhir/ti/StructureDefinition/extension-http-response-info"
      },
      {
    ...
    },
    {
      ...
      },
      {
        ...
        {
          "url" : "errorCode",
          "valueString" : "TIFLOW_EREZEPT_NO_PRESCRIPTIONS_FOUND"
        }],
        "url" : "https://gematik.de/fhir/ti/StructureDefinition/extension-http-response-info"
      }],
