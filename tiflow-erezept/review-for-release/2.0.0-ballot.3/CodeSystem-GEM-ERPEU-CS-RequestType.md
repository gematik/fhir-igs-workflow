# CodeSystem of NCPeH Request Types - Implementation Guide TIFlow - Verordnungen für Arzneimittel v2.0.0-ballot.3
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/tiflow-erezept/CodeSystem/GEM-ERPEU-CS-RequestType | *Version*:2.0.0-ballot.3 |
...
```json
{
  ...
  "url" : "https://gematik.de/fhir/tiflow-erezept/CodeSystem/GEM-ERPEU-CS-RequestType",
