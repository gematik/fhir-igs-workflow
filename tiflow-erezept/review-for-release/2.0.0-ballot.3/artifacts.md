# FHIR-Artefakte - Implementation Guide TIFlow - Verordnungen für Arzneimittel v2.0.0-ballot.3
...
* [Binary einer Verschreibung (QES) mit Metadaten](Binary-PrescriptionBinaryWithMeta.md)

* [Quittungs-Hash Binärdaten](Binary-b939a82a-9c23-4b6d-a139-f468d1b9d652.md)
...
* [Communication searchset response for Rx](Bundle-ExampleCommunicationGetDispReq.md)

* [E-Rezept-Verordnungs-Bundle (unvollständig)](Bundle-ExampleERPBundle.md)

* [Example for a Bundle with a Consent](Bundle-ExampleGetConsent.md)

* [ExampleGetEUPrescriptionBundle](Bundle-ExampleGetEUPrescriptionBundle.md)

* [ExampleMedicationDispenseSearchResponse](Bundle-ExampleMedicationDispenseSearchResponse.md)

* [$accept response for RX](Bundle-ExampleRXAcceptResponse.md)
...
* [Antwort-Nachricht der Apotheke an den Patienten](Communication-ExampleCommunicationReplyPharmacy.md)

* [Rx Communication request example](Communication-ExampleRxCommunicationDispReq.md)

**Consent**

* [Example for a Consent to redeem EU Prescriptions](Consent-ExampleEUConsent.md)
...
* [Beispiel für Abort-Operation Fehlerantwort (412)](OperationOutcome-ExampleERPEUOperationOutcomeError.md)
...
* [Error 403 - Beispiel für Dispense-Operation durch Rollenprüfung](OperationOutcome-ExampleOperationDispenseRoleError.md)

* [Error 400 - Example EU Close operation error response](OperationOutcome-ExampleOperationEUCloseError.md)

* [Error 400 - Example EU Get Prescriptions operation error response](OperationOutcome-ExampleOperationGetEUError.md)
...
* [Example Close Parameters](Parameters-ExampleCloseOutputParameters.md)
...
* [Task aktiviert durch (Z)PVS/KIS via $activate Operation](Task-160.000.033.491.280.78.md)

* [Task angenommen und abgegeben via $dispense Operation](Task-9b48f82c-9c11-4a57-aa72-a805f9537a82.md)

* [Task activated by (Z)PVS/KIS via $activate operation that carries a dispensable ePrescription](Task-ExampleERPEUTaskInReadyState.md)
...
* [Task erstellt durch Fachdienst via $create Operation](Task-TaskInCreatedState.md)
