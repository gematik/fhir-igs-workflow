# GEM ERP EX SupplyOptionsType - Implementation Guide TIFlow - Verordnungen für Arzneimittel v2.0.0-ballot.3
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/erp/StructureDefinition/GEM_ERP_EX_SupplyOptionsType | *Version*:2.0.0-ballot.3 |
| Active as of 2026-06-30 | *Computable Name*:GEM_ERP_EX_SupplyOptionsType |
...
* Examples for this Extension: [Communication/ExampleCommunicationReplyPharmacy](Communication-ExampleCommunicationReplyPharmacy.md)
