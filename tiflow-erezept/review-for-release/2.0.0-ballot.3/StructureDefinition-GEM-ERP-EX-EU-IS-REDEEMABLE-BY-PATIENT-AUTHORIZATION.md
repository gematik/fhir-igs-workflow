# GEM ERP EX EU IS REDEEMABLE BY PATIENT AUTHORIZATION - Implementation Guide TIFlow - Verordnungen für Arzneimittel v2.0.0-ballot.3
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/erp/StructureDefinition/GEM_ERP_EX_EU_IS_REDEEMABLE_BY_PATIENT_AUTHORIZATION | *Version*:2.0.0-ballot.3 |
| Active as of 2026-06-30 | *Computable Name*:GEM_ERP_EX_EU_IS_REDEEMABLE_BY_PATIENT_AUTHORIZATION |
...
* Examples for this Extension: [Task/ExampleERPEUTaskInReadyState](Task-ExampleERPEUTaskInReadyState.md)
