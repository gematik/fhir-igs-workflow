# Verordnung von E-T-Rezepten - Implementation Guide TIFlow - Verordnungen für Arzneimittel v2.0.0-ballot.3
...
1. Bestätigung des Arztes, dass der Patientin oder dem Patienten vor Beginn der medikamentösen Behandlung geeignete medizinische Informationsmaterialien ausgehändigt wurden. (§3a Abs. 2 AMVV)
1. Angabe des Arztes, wenn eine Behandlung außerhalb der jeweils zugelassenen Anwendungsgebiete erfolgt. (§3a Abs. 2 AMVV)
1. Angabe, ob es sich um eine Verschreibung für eine gebärfähige Frau handelt. (§3a Abs. 3 AMVV)
1. Reichdauer des verschriebenen Arzneimittels. (§3a Abs. 3 AMVV)
1. Bestätigung des Arztes, dass er über ausreichende Sachkenntnisse zur Verschreibung von Arzneimitteln nach §3a Abs. 1 Satz 1 AMVV verfügt. (§3a Abs. 5 AMVV)
1. Die auf der Verordnung anzugebene Reichdauer darf die maximal zulässige Reichdauer nicht überschreiten: bei gebärfähigen Frauen 4, andernfalls 12 Wochen (§3a Abs. 3 AMVV). Das Primärsystem soll den Arzt unterstützen, die Reichdauer zu berechnen (z.B. durch die gewählte Packungsgröße und Dosierung) und bei Überschreitung der zulässigen Reichdauer warnen. Sofern die automatische Berechnung nicht möglich ist, muss der Arzt die Reichdauer selbst gemäß der Empfehlung berechnen und erfassen. Das BfArM wird hierzu zeitnah eine Handreichung zur Berechnung der Reichdauer veröffentlichen.
...
**Abbildung: **Beispielhafte Abfrage der Gebärfähigkeit


**Abbildung: **Beispielhafte Darstellung eines E-T-Rezepts im Verordnungsmodul


**Abbildung: **Beispielhafte Darstellung eines Warnhinweises bei Überschreiten der Reichdauer
...
**Abbildung: **Darstellung eines E-T-Rezepts in einer Warenwirtschaft


**Abbildung: **Darstellung von E-T-Rezept-Details in einer Warenwirtschaft
...
**Abbildung: **Darstellung eines Einlösevorgangs von einem E-T-Rezept im E-Rezept-FdV
