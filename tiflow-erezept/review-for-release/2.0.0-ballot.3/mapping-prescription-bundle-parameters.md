# Mapping des Bundles zu Parameters für Verordnungsdaten - Implementation Guide TIFlow - Verordnungen für Arzneimittel v2.0.0-ballot.3
...
* zum [EPAOpProvidePrescriptionERPInputParameters](https://gemspec.gematik.de/ig/fhir/epa-medication/1.3.5/StructureDefinition-epa-op-provide-prescription-erp-input-parameters.html).
