# GEM_ERPEU_EX_MedicinalPackageIdentifier - Implementation Guide TIFlow - Verordnungen für Arzneimittel v2.0.0-ballot.3
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/tiflow-erezept/StructureDefinition/GEM-ERPEU-EX-MedicinalPackageIdentifier | *Version*:2.0.0-ballot.3 |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/de.gematik.tiflow.erezept|current/StructureDefinition/StructureDefinition-GEM-ERPEU-EX-MedicinalPackageIdentifier.json)
...
```json
{
  ...
  "url" : "https://gematik.de/fhir/tiflow-erezept/StructureDefinition/GEM-ERPEU-EX-MedicinalPackageIdentifier",
  ...
  "differential" : {
    ...
    },
    {
      "id" : "Extension.url",
      "path" : "Extension.url",
      "fixedUri" : "https://gematik.de/fhir/tiflow-erezept/StructureDefinition/GEM-ERPEU-EX-MedicinalPackageIdentifier"
    },
    {
