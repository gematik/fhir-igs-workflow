# Example Dispense Parameters - Implementation Guide TIFlow - Verordnungen für Arzneimittel v2.0.0-ballot.3
...
* **Example Dispense Parameters**

## Example Parameters: Example Dispense Parameters
...
```json
{
  ...
  "id" : "ExampleDispenseInputParametersKombipackung",
  "meta" : {
    "profile" : ["https://gematik.de/fhir/tiflow-erezept/StructureDefinition/GEM-ERP-PR-PAR-Dispense-Operation-Input"]
  },
  "parameter" : [{
    "name" : "rxDispensation",
    "part" : [{
