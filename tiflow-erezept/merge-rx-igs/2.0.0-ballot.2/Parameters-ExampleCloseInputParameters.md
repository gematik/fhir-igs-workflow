# Beispiel Close-Parameter - Implementation Guide TIFlow - Verordnungen für Arzneimittel v2.0.0-ballot.2
...
* **Beispiel Close-Parameter**

## Example Parameters: Beispiel Close-Parameter
...
```json
{
  ...
  "meta" : {
    "profile" : ["https://gematik.de/fhir/tiflow-erezept/StructureDefinition/GEM-ERP-PR-PAR-Close-Operation-Input"]
  },
  "parameter" : [{
    "name" : "rxDispensation",
    "part" : [{
