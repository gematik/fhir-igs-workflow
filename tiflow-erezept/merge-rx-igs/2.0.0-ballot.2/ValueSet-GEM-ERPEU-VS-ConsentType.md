# ValueSet of Consent Codes - Implementation Guide TIFlow - Verordnungen für Arzneimittel v2.0.0-ballot.2
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/tiflow-erezept/ValueSet/GEM-ERPEU-VS-ConsentType | *Version*:2.0.0-ballot.2 |
| Draft as of 2026-06-30 | *Computable Name*:GEM_ERPEU_VS_ConsentType |
...
```json
{
  ...
  "url" : "https://gematik.de/fhir/tiflow-erezept/ValueSet/GEM-ERPEU-VS-ConsentType",
