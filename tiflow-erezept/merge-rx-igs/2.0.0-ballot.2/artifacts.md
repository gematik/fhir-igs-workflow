...
| [ TIFLOW XBORDER Operation Outcome Details CS ](CodeSystem-tiflow-xborder-operation-outcome-details-cs.md) | Fehlercodes für cross-border Szenarien, die im Rahmen des TIFlow in den OperationOutcomes.details angegeben werden können |
