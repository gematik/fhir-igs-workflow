# Medication Without code or system for Strength - Implementation Guide TIFlow - Verordnungen für Arzneimittel v2.0.0-ballot.2
...
```json
{
  ...
  "id" : "EU-Medication-Without-Strength-Code",
  "meta" : {
