# TIFLOW XBORDER Operation Outcome Details CS - Implementation Guide TIFlow - Verordnungen für Arzneimittel v2.0.0-ballot.2
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/tiflow-erezept/CodeSystem/tiflow-xborder-operation-outcome-details-cs | *Version*:2.0.0-ballot.2 |
| Draft as of 2026-06-30 | *Computable Name*:TIFLOWXBORDEROperationOutcomeDetailsCS |
...
```json
{
  ...
  "url" : "https://gematik.de/fhir/tiflow-erezept/CodeSystem/tiflow-xborder-operation-outcome-details-cs",
