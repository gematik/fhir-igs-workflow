...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/erp/StructureDefinition/eflow-rx-acceptdate-extension | *Version*:1.0.0-draft |
| Draft as of 2025-12-15 | *Computable Name*:EFlowRxAcceptDateExtension |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/de.gematik.eflow-rx|current/StructureDefinition/eflow-rx-acceptdate-extension)
...
Other representations of profile: [CSV](StructureDefinition-eflow-rx-acceptdate-extension.csv), [Excel](StructureDefinition-eflow-rx-acceptdate-extension.xlsx), [Schematron](StructureDefinition-eflow-rx-acceptdate-extension.sch) 
...
```json
{
  ...
  "version" : "1.0.0-draft",
  "name" : "EFlowRxAcceptDateExtension",
  ...
  "differential" : {
    "element" : [
      ...
      },
      {
        "id" : "Extension.url",
        "path" : "Extension.url",
        "fixedUri" : "https://gematik.de/fhir/erp/StructureDefinition/eflow-rx-acceptdate-extension"
      },
      {
