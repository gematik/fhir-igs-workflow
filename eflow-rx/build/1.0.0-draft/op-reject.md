...
* [FD-Anforderungen zu `$reject`](./op-reject-fd-requirements.md): Anforderungen an den E-Rezept-Fachdienst zur Bereitstellung der Schnittstelle.
* [Client-Anforderungen zu `$reject`](./op-reject-client-requirements.md): Anforderungen an den Client des E-Rezept-Fachdienstes zur Nutzung der Schnittstelle.
...
**Abbildung: **Ablauf Operation `$reject`
