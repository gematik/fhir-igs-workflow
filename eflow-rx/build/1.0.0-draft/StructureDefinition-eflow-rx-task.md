...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/erp/StructureDefinition/eflow-rx-task | *Version*:1.0.0-draft |
| Draft as of 2025-12-15 | *Computable Name*:EFlowRxTask |
...
* Use this Profile: [GEM ERP PR ActivateOperation Output](StructureDefinition-eflow-rx-activate-operation-output-parameters.md), [GEM ERP PR Bundle OP Accept](StructureDefinition-eflow-rx-bundle-op-accept.md) and [GEM ERP PR CreateOperation Output](StructureDefinition-eflow-rx-create-operation-output-parameters.md)
* Refer to this Profile: [GEM ERP PR Communication](StructureDefinition-eflow-rx-communication.md)
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/de.gematik.eflow-rx|current/StructureDefinition/eflow-rx-task)
...
Other representations of profile: [CSV](StructureDefinition-eflow-rx-task.csv), [Excel](StructureDefinition-eflow-rx-task.xlsx), [Schematron](StructureDefinition-eflow-rx-task.sch) 
...
```json
{
  ...
  "id" : "eflow-rx-task",
  "url" : "https://gematik.de/fhir/erp/StructureDefinition/eflow-rx-task",
  "version" : "1.0.0-draft",
  "name" : "EFlowRxTask",
  ...
  "differential" : {
    "element" : [
        ...
        "type" : [
          {
            "code" : "Extension",
            "profile" : [
              "https://gematik.de/fhir/erp/StructureDefinition/eflow-rx-prescriptiontype-extension"
            ]
          }
        ],
        "mustSupport" : true
        ...
        "type" : [
          {
            "code" : "Extension",
            "profile" : [
              "https://gematik.de/fhir/erp/StructureDefinition/eflow-rx-acceptdate-extension"
            ]
          }
        ],
        "mustSupport" : true
        ...
        "type" : [
          {
            "code" : "Extension",
            "profile" : [
              "https://gematik.de/fhir/erp/StructureDefinition/eflow-rx-expirydate-extension"
            ]
          }
        ],
        "mustSupport" : true
        ...
        "type" : [
          {
            "code" : "Extension",
            "profile" : [
              "https://gematik.de/fhir/erp/StructureDefinition/eflow-rx-lastmedicationdispense-extension"
            ]
          }
        ]
      },
        ...
        "type" : [
          {
            "code" : "Extension",
            "profile" : [
              "https://gematik.de/fhir/erp/StructureDefinition/eflow-rx-eu-is-redeemable-by-properties-extension"
            ]
          }
        ],
        "mustSupport" : true
        ...
        "type" : [
          {
            "code" : "Extension",
            "profile" : [
              "https://gematik.de/fhir/erp/StructureDefinition/eflow-rx-eu-is-redeemable-by-patient-authorization-extension"
            ]
          }
        ],
        "mustSupport" : true
        ...
        "type" : [
          {
            "code" : "Identifier",
            "profile" : [
              "https://gematik.de/fhir/erp/StructureDefinition/eflow-rx-secret"
            ]
          }
        ]
      },
      ...
      },
      {
        ...
        "binding" : {
          "strength" : "required",
          "valueSet" : "https://gematik.de/fhir/erp/ValueSet/eflow-rx-organizationtype"
        }
      },
      {
        "id" : "Task.input",
