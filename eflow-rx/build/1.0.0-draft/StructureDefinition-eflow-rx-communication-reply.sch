...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <!-- 
    This file contains just the constraints for the profile EFlowRxCommunication
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Communication/f:payload">
      <sch:assert test="count(f:extension[@url = 'https://gematik.de/fhir/erp/StructureDefinition/eflow-rx-supplyoptionstype-extension']) &lt;= 1">extension with URL = 'https://gematik.de/fhir/erp/StructureDefinition/eflow-rx-supplyoptionstype-extension': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://gematik.de/fhir/erp/StructureDefinition/eflow-rx-availabilitystate-extension']) &lt;= 1">extension with URL = 'https://gematik.de/fhir/erp/StructureDefinition/eflow-rx-availabilitystate-extension': maximum cardinality of 'extension' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
</sch:schema>
