...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/erp/StructureDefinition/eflow-rx-auditevent | *Version*:1.0.0-draft |
| Draft as of 2025-12-15 | *Computable Name*:EFlowRxAuditEvent |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/de.gematik.eflow-rx|current/StructureDefinition/eflow-rx-auditevent)
...
Other representations of profile: [CSV](StructureDefinition-eflow-rx-auditevent.csv), [Excel](StructureDefinition-eflow-rx-auditevent.xlsx), [Schematron](StructureDefinition-eflow-rx-auditevent.sch) 
...
```json
{
  ...
  "url" : "https://gematik.de/fhir/erp/StructureDefinition/eflow-rx-auditevent",
  "version" : "1.0.0-draft",
  "name" : "EFlowRxAuditEvent",
