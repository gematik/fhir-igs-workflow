...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/erp/CodeSystem/eflow-rx-operationoutcomedetails | *Version*:1.0.0-draft |
| Draft as of 2025-12-15 | *Computable Name*:EFlowRxOperationOutcomeDetailsCS |
...
* [EFlowRxOperationOutcomeDetailsVS](ValueSet-eflow-rx-operationoutcomedetails.md)
...
```json
{
  ...
  "url" : "https://gematik.de/fhir/erp/CodeSystem/eflow-rx-operationoutcomedetails",
  "version" : "1.0.0-draft",
  "name" : "EFlowRxOperationOutcomeDetailsCS",
