...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/erp/StructureDefinition/eflow-rx-communication | *Version*:1.0.0-draft |
| Draft as of 2025-12-15 | *Computable Name*:EFlowRxCommunication |
...
* Derived from this Profile: [GEM ERP PR Communication Reply](StructureDefinition-eflow-rx-communication-reply.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/de.gematik.eflow-rx|current/StructureDefinition/eflow-rx-communication)
...
Other representations of profile: [CSV](StructureDefinition-eflow-rx-communication.csv), [Excel](StructureDefinition-eflow-rx-communication.xlsx), [Schematron](StructureDefinition-eflow-rx-communication.sch) 
...
```json
{
  ...
  "url" : "https://gematik.de/fhir/erp/StructureDefinition/eflow-rx-communication",
  "version" : "1.0.0-draft",
  "name" : "EFlowRxCommunication",
