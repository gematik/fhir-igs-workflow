...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Communication">
      <sch:assert test="count(f:extension[@url = 'https://gematik.de/fhir/erp/StructureDefinition/eflow-rx-prescriptiontype-extension']) &gt;= 1">extension with URL = 'https://gematik.de/fhir/erp/StructureDefinition/eflow-rx-prescriptiontype-extension': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://gematik.de/fhir/erp/StructureDefinition/eflow-rx-prescriptiontype-extension']) &lt;= 1">extension with URL = 'https://gematik.de/fhir/erp/StructureDefinition/eflow-rx-prescriptiontype-extension': maximum cardinality of 'extension' is 1</sch:assert>
