...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/erp/StructureDefinition/eflow-rx-communication-dispreq | *Version*:1.0.0-draft |
| Draft as of 2025-12-15 | *Computable Name*:EFlowRxCommunicationDispReq |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/de.gematik.eflow-rx|current/StructureDefinition/eflow-rx-communication-dispreq)
...
Other representations of profile: [CSV](StructureDefinition-eflow-rx-communication-dispreq.csv), [Excel](StructureDefinition-eflow-rx-communication-dispreq.xlsx), [Schematron](StructureDefinition-eflow-rx-communication-dispreq.sch) 
...
```json
{
  ...
  "url" : "https://gematik.de/fhir/erp/StructureDefinition/eflow-rx-communication-dispreq",
  "version" : "1.0.0-draft",
  "name" : "EFlowRxCommunicationDispReq",
        ...
        "constraint" : [
          {
            ...
            "source" : "https://gematik.de/fhir/erp/StructureDefinition/eflow-rx-communication-dispreq"
          }
        ]
      },
      {
