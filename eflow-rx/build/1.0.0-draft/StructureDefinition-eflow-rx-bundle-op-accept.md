...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/erp/StructureDefinition/eflow-rx-bundle-op-accept | *Version*:1.0.0-draft |
| Draft as of 2025-12-15 | *Computable Name*:EFlowRxBundleOPAccept |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/de.gematik.eflow-rx|current/StructureDefinition/eflow-rx-bundle-op-accept)
...
Other representations of profile: [CSV](StructureDefinition-eflow-rx-bundle-op-accept.csv), [Excel](StructureDefinition-eflow-rx-bundle-op-accept.xlsx), [Schematron](StructureDefinition-eflow-rx-bundle-op-accept.sch) 
...
```json
{
  ...
  "url" : "https://gematik.de/fhir/erp/StructureDefinition/eflow-rx-bundle-op-accept",
  "version" : "1.0.0-draft",
  "name" : "EFlowRxBundleOPAccept",
