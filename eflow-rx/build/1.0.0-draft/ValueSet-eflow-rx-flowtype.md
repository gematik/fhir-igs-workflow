...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/erp/ValueSet/eflow-rx-flowtype | *Version*:1.0.0-draft |
| Draft as of 2025-12-15 | *Computable Name*:EFlowRxFlowTypeVS |
...
* [GEM ERP EX PrescriptionType](StructureDefinition-eflow-rx-prescriptiontype-extension.md)
...
```json
{
  ...
  "url" : "https://gematik.de/fhir/erp/ValueSet/eflow-rx-flowtype",
  "version" : "1.0.0-draft",
  "name" : "EFlowRxFlowTypeVS",
