...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/erp/CodeSystem/GEM-ERP-CS-OrganizationType | *Version*:1.0.0-draft |
...
```json
{
  ...
  "url" : "https://gematik.de/fhir/erp/CodeSystem/GEM-ERP-CS-OrganizationType",
  "version" : "1.0.0-draft",
