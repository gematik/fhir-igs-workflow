# Beispiel Close-Parameter - E-Rezept für Arzneimittel v1.0.0-draft
...
```json
{
  ...
  "meta" : {
    "profile" : [
      "https://gematik.de/fhir/erp/StructureDefinition/eflow-rx-close-operation-input-parameters"
    ]
  },
  "parameter" : [
    {
