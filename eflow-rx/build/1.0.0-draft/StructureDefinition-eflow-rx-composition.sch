...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Composition">
      <sch:assert test="count(f:extension[@url = 'https://gematik.de/fhir/erp/StructureDefinition/eflow-rx-beneficiary-extension']) &gt;= 1">extension with URL = 'https://gematik.de/fhir/erp/StructureDefinition/eflow-rx-beneficiary-extension': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://gematik.de/fhir/erp/StructureDefinition/eflow-rx-beneficiary-extension']) &lt;= 1">extension with URL = 'https://gematik.de/fhir/erp/StructureDefinition/eflow-rx-beneficiary-extension': maximum cardinality of 'extension' is 1</sch:assert>
