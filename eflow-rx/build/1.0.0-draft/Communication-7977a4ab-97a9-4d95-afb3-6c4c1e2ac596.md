...
Profile: [GEM ERP PR Communication Reply](StructureDefinition-eflow-rx-communication-reply.md)
...
> **payload****GEM ERP EX AvailabilityState**: [CodeSystem des Verfügbarkeitsstatus: 20](CodeSystem-eflow-rx-availabilitystatus.md#eflow-rx-availabilitystatus-20) (noch Heute verfügbar)
...
```json
{
  ...
  "meta" : {
    "profile" : [
      "https://gematik.de/fhir/erp/StructureDefinition/eflow-rx-communication-reply"
    ],
    "tag" : [
      {
      ...
      "extension" : [
        {
          ...
          "valueCoding" : {
            "system" : "https://gematik.de/fhir/erp/CodeSystem/eflow-rx-availabilitystatus",
            "code" : "20"
          }
        },
        {
