...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/erp/CodeSystem/eflow-rx-flowtype | *Version*:1.0.0-draft |
| Draft as of 2025-12-15 | *Computable Name*:EFlowRxFlowTypeCS |
...
* [EFlowRxFlowTypeVS](ValueSet-eflow-rx-flowtype.md)
...
```json
{
  ...
  "url" : "https://gematik.de/fhir/erp/CodeSystem/eflow-rx-flowtype",
  "version" : "1.0.0-draft",
  "name" : "EFlowRxFlowTypeCS",
