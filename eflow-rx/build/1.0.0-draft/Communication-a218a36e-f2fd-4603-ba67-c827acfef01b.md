...
Profile: [GEM ERP PR Communication DispReq](StructureDefinition-eflow-rx-communication-dispreq.md)
...
```json
{
  ...
  "meta" : {
    "profile" : [
      "https://gematik.de/fhir/erp/StructureDefinition/eflow-rx-communication-dispreq"
    ],
    "tag" : [
      {
