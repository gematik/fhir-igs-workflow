...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:CapabilityStatement">
      ...
      <sch:assert test="count(f:extension[@url = 'https://gematik.de/fhir/ti/StructureDefinition/ti-environment']) &lt;= 1">extension with URL = 'https://gematik.de/fhir/ti/StructureDefinition/ti-environment': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://gematik.de/fhir/ti/StructureDefinition/ti-fhir-configuration']) &lt;= 1">extension with URL = 'https://gematik.de/fhir/ti/StructureDefinition/ti-fhir-configuration': maximum cardinality of 'extension' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
