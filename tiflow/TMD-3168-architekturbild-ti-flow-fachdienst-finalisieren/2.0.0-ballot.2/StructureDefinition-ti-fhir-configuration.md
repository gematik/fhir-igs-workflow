# TI FHIR Configuration - TIFlow - Kernfunktionalitäten v2.0.0-ballot.2
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/tiflow/StructureDefinition/ti-fhir-configuration | *Version*:2.0.0-ballot.2 |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/de.gematik.tiflow|current/StructureDefinition/StructureDefinition-ti-fhir-configuration.json)
