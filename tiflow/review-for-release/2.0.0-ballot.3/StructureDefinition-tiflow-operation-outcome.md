# TIFlow OperationOutcome - Implementation Guide TIFlow - Kernfunktionalitäten v2.0.0-ballot.3
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/tiflow/StructureDefinition/tiflow-operation-outcome | *Version*:2.0.0-ballot.3 |
