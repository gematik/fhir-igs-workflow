# CapabilityStatement für den TI-Flow-Fachdienst - Implementation Guide TIFlow - Kernfunktionalitäten v2.0.0-ballot.3
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/tiflow/CapabilityStatement/ti-flow-fachdienst-server | *Version*:2.0.0-ballot.3 |
