# TI Feature Definition - Implementation Guide TIFlow - Kernfunktionalitäten v2.0.0-ballot.3
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/tiflow/StructureDefinition/ti-feature-definition | *Version*:2.0.0-ballot.3 |
| Draft as of 2026-08-25 | *Computable Name*:TIFeatureDefinition |
...
```json
{
  ...
  "status" : "draft",
  "date" : "2026-08-25T08:13:21+00:00",
