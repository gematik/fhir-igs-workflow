# TI Flow AcceptDate - Implementation Guide TIFlow - Kernfunktionalitäten v2.0.0-ballot.3
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/erp/StructureDefinition/GEM_ERP_EX_AcceptDate | *Version*:2.0.0-ballot.3 |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/de.gematik.tiflow|current/StructureDefinition/StructureDefinition-GEM-ERP-EX-AcceptDate.json)
