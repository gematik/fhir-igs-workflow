# CodeSystem der Flowtypes in TIFlow Anwendungen - Implementation Guide TIFlow - Kernfunktionalitäten v2.0.0-ballot.3
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/erp/CodeSystem/GEM_ERP_CS_FlowType | *Version*:2.0.0-ballot.3 |
