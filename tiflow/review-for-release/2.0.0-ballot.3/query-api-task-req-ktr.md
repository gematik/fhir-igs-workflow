# KTR-Anforderungen: Task-Query - Implementation Guide TIFlow - Kernfunktionalitäten v2.0.0-ballot.3
...
funkt. Eignung: HerstellererklärungDas Clientsystem Kostenträger MUSS im Anwendungsfall "Recovery Secret" für die Verordnung die HTTP-Operation GET /Task/<id>/ mit
* Task-ID in URL <id> 
...
funkt. Eignung: HerstellererklärungDas Clientsystem Kostenträger MUSS im Anwendungsfall "Quittung erneut abrufen" für die Verordnung die HTTP-Operation GET /Task/<id>/ mit
* Task-ID in URL <id> 
