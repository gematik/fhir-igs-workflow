# Query API: MedicationDispense - Implementation Guide TIFlow - Kernfunktionalitäten v2.0.0-ballot.2
...
Die Nachricht zur Interaktion mit Dispensierinformationen am TI-Flow-Fachdienst als FHIR-Ressource **MedicationDispense** wird über den `/MedicationDispense` Endpunkt für das jeweilige Modul unterstützt.
