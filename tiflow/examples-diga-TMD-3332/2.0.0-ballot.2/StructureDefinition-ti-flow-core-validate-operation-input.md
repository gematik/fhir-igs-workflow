# TIFlow CORE Validate Operation Input - Implementation Guide TIFlow - Kernfunktionalitäten v2.0.0-ballot.2
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/tiflow/StructureDefinition/ti-flow-core-validate-operation-input | *Version*:2.0.0-ballot.2 |
