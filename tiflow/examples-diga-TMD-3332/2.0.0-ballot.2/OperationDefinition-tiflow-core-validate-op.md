# Validieren einer FHIR-Ressource - Implementation Guide TIFlow - Kernfunktionalitäten v2.0.0-ballot.2
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/tiflow/OperationDefinition/tiflow-core-validate-op | *Version*:2.0.0-ballot.2 |
