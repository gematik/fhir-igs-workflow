# Beispielantwort fuer die $accept-Operation - TIFlow - Kernfunktionalitäten v1.0.0-draft
...
```json
{
  ...
  },
  {
    ...
    "resource" : {
      ...
      "meta" : {
        "profile" : ["https://gematik.de/fhir/erp/StructureDefinition/GEM_ERP_PR_Binary|1.6"]
      },
