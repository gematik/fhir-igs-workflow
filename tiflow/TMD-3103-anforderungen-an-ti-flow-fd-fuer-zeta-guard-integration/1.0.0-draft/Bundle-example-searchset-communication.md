# Antwortbundle fuer GET /Communication - TIFlow - Kernfunktionalitäten v1.0.0-draft
...
* **Antwortbundle fuer GET /Communication**

## Example Bundle: Antwortbundle fuer GET /Communication
...
```json
{
  ...
  "link" : [{
    "relation" : "self",
    "url" : "https://erp-ref.zentral.erp.splitdns.ti-dienste.de/Communication?received=NULL"
  }],
  "entry" : [{
    "fullUrl" : "https://erp-ref.zentral.erp.splitdns.ti-dienste.de/Communication/Communication_DispenseRequest",
    "resource" : {
  ...
  {
    "fullUrl" : "https://erp-ref.zentral.erp.splitdns.ti-dienste.de/Communication/Communication_Reply_Pharmacy",
    "resource" : {
      "resourceType" : "Communication",
