# Logical Medication Dispense - TIFlow - Kernfunktionalitäten v1.0.0-draft
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/tiflow/core/StructureDefinition/GEM-ERP-LOG-MedicationDispense | *Version*:1.0.0-draft |
| Draft as of 2025-09-25 | *Computable Name*:GEM_ERP_LOG_MedicationDispense |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/de.gematik.tiflow.core|current/StructureDefinition/GEM-ERP-LOG-MedicationDispense)
...
```json
{
  ...
  "url" : "https://gematik.de/fhir/tiflow/core/StructureDefinition/GEM-ERP-LOG-MedicationDispense",
  "version" : "1.0.0-draft",
  ...
  "kind" : "logical",
  "abstract" : false,
  "type" : "https://gematik.de/fhir/tiflow/core/StructureDefinition/GEM-ERP-LOG-MedicationDispense",
