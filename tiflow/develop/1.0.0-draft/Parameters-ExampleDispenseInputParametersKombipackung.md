# Example Dispense Parameters - TIFlow - Kernfunktionalitäten v1.0.0-draft
...
```json
{
  ...
  "meta" : {
    "profile" : ["https://gematik.de/fhir/erp/StructureDefinition/GEM_ERP_PR_PAR_DispenseOperation_Input|1.6"]
  },
  "parameter" : [{
    "name" : "rxDispensation",
    "part" : [{
