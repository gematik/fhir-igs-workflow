# Feature: WF169 - Flowtype für Apothekenpflichtige Arzneimittel mit Steuerung durch den Leistungserbringer - TIFlow - Kernfunktionalitäten v2.0.0-ballot.1
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/tiflow-core/StructureDefinition/ti-flow-feature-wf169 | *Version*:2.0.0-ballot.1 |
| Active as of 2028-04-01 | *Computable Name*:TIFlowFeatureWF169 |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/de.gematik.tiflow.core|current/StructureDefinition/ti-flow-feature-wf169)
...
```json
{
  ...
  "url" : "https://gematik.de/fhir/tiflow-core/StructureDefinition/ti-flow-feature-wf169",
  ...
  "kind" : "logical",
  "abstract" : false,
  "type" : "https://gematik.de/fhir/tiflow-core/StructureDefinition/ti-flow-feature-wf169",
