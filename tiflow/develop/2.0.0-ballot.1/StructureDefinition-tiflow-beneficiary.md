# TIFlow Beneficiary - TIFlow - Kernfunktionalitäten v2.0.0-ballot.1
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/erp/StructureDefinition/GEM_ERP_EX_Beneficiary | *Version*:2.0.0-ballot.1 |
| Active as of 2028-04-01 | *Computable Name*:TIFlowBeneficiary |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/de.gematik.tiflow.core|current/StructureDefinition/tiflow-beneficiary)
...
Other representations of profile: [CSV](StructureDefinition-tiflow-beneficiary.csv), [Excel](StructureDefinition-tiflow-beneficiary.xlsx), [Schematron](StructureDefinition-tiflow-beneficiary.sch) 
