# TIFlow Receipt Bundle - TIFlow - Kernfunktionalitäten v2.0.0-ballot.1
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/erp/StructureDefinition/GEM_ERP_PR_Bundle | *Version*:2.0.0-ballot.1 |
| Active as of 2028-04-01 | *Computable Name*:TIFlowReceiptBundle |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/de.gematik.tiflow|current/StructureDefinition/StructureDefinition-tiflow-receipt-bundle.json)
...
Other representations of profile: [CSV](StructureDefinition-tiflow-receipt-bundle.csv), [Excel](StructureDefinition-tiflow-receipt-bundle.xlsx), [Schematron](StructureDefinition-tiflow-receipt-bundle.sch) 
