# GEM ERP PR Composition - Implementation Guide TIFlow - Kernfunktionalitäten v2.0.0-ballot.2
...
| Active as of 2026-06-30 | *Computable Name*:GEM_ERP_PR_Composition |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/de.gematik.tiflow|current/StructureDefinition/StructureDefinition-GEM-ERP-PR-Composition.json)
