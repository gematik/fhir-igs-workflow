# TIFlow CORE Validate Operation Output - Implementation Guide TIFlow - Kernfunktionalitäten v2.0.0-ballot.2
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/tiflow/StructureDefinition/ti-flow-core-validate-operation-output | *Version*:2.0.0-ballot.2 |
