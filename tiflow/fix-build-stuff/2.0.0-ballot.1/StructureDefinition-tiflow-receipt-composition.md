# GEM ERP PR Composition - TIFlow - Kernfunktionalitäten v2.0.0-ballot.1
...
| | |
| :--- | :--- |
| *Official URL*:https://gematik.de/fhir/erp/StructureDefinition/GEM_ERP_PR_Composition | *Version*:2.0.0-ballot.1 |
| Active as of 2028-04-01 | *Computable Name*:TIFlowReceiptComposition |
| **Copyright/Legal**: gematik GmbH / Dieses Artefakt ist lizenziert unter [Apache License](./license.md), Version 2.0. | |

 
Composition für die Quittung für die Einlösung eines E-Rezepts 

**Usages:**

* Use this Profile: [TIFlow Receipt Bundle](StructureDefinition-tiflow-receipt-bundle.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/de.gematik.tiflow|current/StructureDefinition/StructureDefinition-tiflow-receipt-composition.json)
...
Other representations of profile: [CSV](StructureDefinition-tiflow-receipt-composition.csv), [Excel](StructureDefinition-tiflow-receipt-composition.xlsx), [Schematron](StructureDefinition-tiflow-receipt-composition.sch) 
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://gematik.de/fhir/erp/StructureDefinition/GEM_ERP_EX_Beneficiary"]
      }],
      "mustSupport" : true
    },
    {
